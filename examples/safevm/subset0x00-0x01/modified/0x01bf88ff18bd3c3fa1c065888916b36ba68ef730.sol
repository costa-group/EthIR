...
contract Crowdsale is Haltable {
   ...
   */
  enum State{Unknown, Preparing, PreFunding, Funding, Success, Failure, Finalized, Refunding} // SAFEVM enum data type producing INVALID instructions
...
contract UpgradeableToken is StandardToken {
   ...
   *
   */
  enum UpgradeState {Unknown, NotAllowed, WaitingForAgent, ReadyToUpgrade, Upgrading} // SAFEVM enum data type producing INVALID instructions
