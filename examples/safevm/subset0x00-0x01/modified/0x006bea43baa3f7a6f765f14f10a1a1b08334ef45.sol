...
contract SafeMath {
    ...
    */
    function safeMul(uint256 _x, uint256 _y) internal returns (uint256) {
        uint256 z = _x * _y;
        assert(_x == 0 || z / _x == _y); // SAFEVM Not used
        return z;
    }
}
...
contract TokenHolder is ITokenHolder, Owned {
    ...
    */
    function withdrawTokens(IERC20Token _token, address _to, uint256 _amount)
        ...
        notThis(_to)
    {
        assert(_token.transfer(_to, _amount));   // SAFEVM Method result
    }
}
...
contract SmartToken is ISmartToken, ERC20Token, Owned, TokenHolder {
    ...
    */
    function transfer(address _to, uint256 _value) public transfersAllowed returns (bool success) {
        assert(super.transfer(_to, _value)); // SAFEVM Method result
    ...
    */
    function transferFrom(address _from, address _to, uint256 _value) public transfersAllowed returns (bool success) {
        assert(super.transferFrom(_from, _to, _value));  // SAFEVM Method result
