...
// File: contracts/QuantaNetworks.sol

pragma solidity ^0.6.0;


/**
 * @title QuantaNetworks
 ...
 */
contract QuantaNetworks is ERC777 {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC777("Quanta Networks", "QN", new address[](0)) {
        _mint(msg.sender, 2000000000 * 10 ** 0, "", "");
    }
}