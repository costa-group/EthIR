...
contract GetPrices{
    ...
    function getKyberBuyPrice() constant external returns (uint256){
       uint256 currentPriceKyber =  orfeed.getExchangeRate("ETH", "DAI", "BUY-KYBER-EXCHANGE", 1000000000000000000);
        return currentPriceKyber;
    }
    


     function getUniswapSellPrice() constant external returns (uint256){
       uint256 currentPriceUniswap =  orfeed.getExchangeRate("ETH", "DAI", "UNISWAPBYSYMBOLV1", 1000000000000000000);
