...
contract TokenizeXchange is ERC20Interface, Owned, SafeMath {
	...
	string constant public name = "TokenizeXchange_v1";
	string constant public symbol = "TKXX";
