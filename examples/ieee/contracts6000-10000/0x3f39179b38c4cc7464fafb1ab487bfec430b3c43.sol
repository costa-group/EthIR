...
/**
 * TFBEE Token, totalSupply 100000000000000
 */
contract TfbeeToken is BurnableToken, CappedToken(100000000000000) {
    string public constant name = "TrafficBee Token";
    string public constant symbol = "TFBEE";
