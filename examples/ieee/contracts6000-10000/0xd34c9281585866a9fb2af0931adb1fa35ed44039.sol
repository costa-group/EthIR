...
/**
 * @title Be Gaming Coin
 * @dev Be Gaming Coin is an ERC223 Token with ERC20 functions and events
 *      Fully backward compatible with ERC20
 */
contract BeGamingCoin is ERC223, Ownable {
    using SafeMath for uint256;

    string public constant name = "Be Gaming Coin";
    string public constant symbol = "BGC";
    uint8 public constant decimals = 8;
    uint256 public totalSupply = 3000000000 * 10 ** 8;
