...
interface DharmaTradeReserveV11Interface {
  event Trade(
    address account,
...
/**
 * @title DharmaTradeReserveV11ImplementationStaging
 * @author 0age
 ...
 */
contract DharmaTradeReserveV11ImplementationStaging is DharmaTradeReserveV11Interface, TwoStepOwnable {
  ...
  uint256 private constant _VERSION = 11;
  ...
  function tradeDaiForEtherUsingReserves(
    ...
    _fireTradeEvent(
      ...
      daiAmountFromReserves,
      quotedEtherAmount,
      totalDaiSold.sub(daiAmountFromReserves)
    );
  }
  ...
  function tradeDaiForTokenUsingReserves(
    ...
    uint256 retainedDai = totalDaiSold.sub(daiAmountFromReserves);
