...
contract DfDepositMarket is FundsMgr, DSMath {
    ...
    address public constant dDAI_ADDRESS = 0xe3Fc8afE4a1F0D19EAbA5aF03b0e5a79a3504729;

    // 1 DAI == 1 dDAI token
    function getDiDai(IToken _fromToken, uint256 _amountFromToken, uint256 _minAmountdDaiToken, bytes memory _data) public {
        uint256 total;
