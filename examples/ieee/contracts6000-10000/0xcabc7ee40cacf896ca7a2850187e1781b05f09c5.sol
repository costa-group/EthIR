...
library SafeERC20 {
    ...
    function safeTransferFrom(IERC20 token, address from, address to, uint256 value) internal {
        callOptionalReturn(token, abi.encodeWithSelector(token.transferFrom.selector, from, to, value));  /* --change-- transferToken to transferTokenFrom */
    }
...
contract NexxoTokensUpgrade1 is Initializable, PausableUpgradeSafe, OwnableUpgradeSafe, ERC20UpgradeSafe {
        ...
        //end customize
         ...
         // Start : to block and unblock particular address (nexxo customize).
            struct EntityStruct {
            ...
            address[] private blockedAddressList;            /* unordered list of keys that actually exist */
         // End : to block and unblock particular address


	    //constructor(string memory name, string memory symbol, address payable ownerAccount, uint256 totalSupply, uint256 unitsOneEthCanBuy, uint8 decimals) public payable {
        //  __NexxoTokens001_init(name, symbol, ownerAccount, totalSupply, unitsOneEthCanBuy, decimals);
       // }
      ...
      receive() external payable whenNotPaused {
        ...
        emit Transfer(ownerWallet(), _msgSender(), amount); // Broadcast a message to the blockchain
