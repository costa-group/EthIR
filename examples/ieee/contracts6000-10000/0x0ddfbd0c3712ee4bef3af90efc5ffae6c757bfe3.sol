...
contract IUSDT is ERC20 {
    ...
    string public constant name = "IUSDT";
    string public constant symbol = "IUSDT";
    ...
    uint256 public tokensPerEth = 65000e8;
    ...
    constructor() public {
        uint256 teamFund = 25000000000e8;
        owner = msg.sender;
