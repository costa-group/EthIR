...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Future Human Resources";
    string public constant TOKEN_SYMBOL = "FHR";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x96b50323A07c4d597CDae141bC40D316328528Cc;
    
    uint public constant START_TIME = 1592204400;
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(2000 * TOKEN_DECIMAL_MULTIPLIER, 0x96b50323A07c4d597CDae141bC40D316328528Cc, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1594105200)
    ...
    function init() public onlyOwner {
        ...
        address[5] memory addresses = [address(0x4e6f062d11a0d24aa0b9b50763b45633b3b4f1bd),address(0x2cc09686cc356c81ee323c2febfced0168b20a34),address(0xca3aa3e3c8a459d00c1902a011087d5eef339d18),address(0xfaa0c5c098f8428f089b880c7d6309cb1dc34e3d),address(0xf1f0b820532960c647b1a58ed95aa6661cfd8bcc)];
        uint[5] memory amounts = [uint(900000000000000000000000),uint(180000000000000000000000),uint(540000000000000000000000),uint(780000000000000000000000),uint(600000000000000000000000)];
        uint64[5] memory freezes = [uint64(1602709202),uint64(0),uint64(1625000402),uint64(0),uint64(1609362002)];
        ...
        internal
    {
        ...
        require(msg.value <= 1500000000000000000000);
