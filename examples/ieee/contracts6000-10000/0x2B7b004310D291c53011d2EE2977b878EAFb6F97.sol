...
contract TokenMintERC20Token is ERC20 {
     ...
     */
    constructor(string memory name, string memory symbol, uint8 decimals, uint256 totalSupply, uint256 priceInWei, address payable tokenOwnerAddress) public  {
      _name = name;
      _symbol = symbol;
      _decimals = decimals;
    ...
    uint256 amountToMint = (msg.value / _priceInWei) * (10**18);
