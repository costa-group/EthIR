...
contract QTAAR is MintableToken, HasNoEther 
{
    // Using libraries 
    using SafeMath for uint;

    //////////////////////////////////////////////////
    /// State Variables for the QTAAR token contract
    //////////////////////////////////////////////////
    ...
    */
    ...
    // Human token state
    //////////////////////
    string public constant name = "QTAAR.network";
    string public constant symbol = "QTAAR";
    ...
    /// @dev QTAAR token constructor
    function QTAAR() public
    {
        // Define owner
        owner = msg.sender;
    ...
    function stakeQTAAR(uint _stakeAmount) external
    {
    ...
    function stakeQTAARSplit(uint _stakeAmount, address _stakeSplitAddress) external
    {
    ...
    function claimQTAAR() external returns (bool success)
    {
        /// Sanity checks: 
        ...
        // Subtract stake balance from totalQTAARStaked
        totalQTAARStaked -= stakeBalances[msg.sender].initialStakeBalance;
    ...
    function calculateStakeGains(uint _timePassedSinceStake) view private returns (uint mintTotal)
    {
        ...
        uint _finalMintRate;            // store our calculated final mint rate (in QTAAR-per-second)
        ...
        if (_timePassedSinceStake > _secondsPerDay) {
            ...
            // First, calculate our final stake percentage based upon the total amount of QTAAR staked
            _finalStakePercentage = calculateFraction(stakeBalances[msg.sender].initialStakeBalance, totalQTAARStaked, decimals);
            ...
            // Finally, calculate our final mint rate (in QTAAR-per-second)
