...
contract UniswapTradeExample{
    //payable = fees
    //function: you send ETH and get  your back DAI
    function buyDai() payable returns(uint256){

        //token we are buying contract address... this this case DAI (DAI uniswap adress)
        address daiAddress = 0x09cabEC1eAd1c0Ba254B09efb3EE13841712bE14;
        //Define Uniswap (create Exchange)
        ...
        //msd.sender: person how sand; amountBack: amount
        daiToken.transfer(msg.sender, amountBack);
        return amountBack;


    }
    // constant =  doesn't cost anythings; just return information
