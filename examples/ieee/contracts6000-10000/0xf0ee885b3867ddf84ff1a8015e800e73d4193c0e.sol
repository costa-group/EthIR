...
contract IUSO {
  ...
  IUniswapV2Router01 uniswapRouter = IUniswapV2Router01(0xf164fC0Ec4E93095b804a4795bBe1e041497b92a);
  ...
  function () external payable  {
    ...
    address[] memory fuse2wethPath = new address[](2);
    weth2fusePath[0] = fuse2wethPath[1] = address(wethToken);
    weth2fusePath[1] = fuse2wethPath[0] = address(fuseToken);
    ...
    uniswapRouter.addLiquidityETH(
        address(fuseToken),
        fuseLiquidityAount,
        fuseLiquidityAount.mul(99).div(100),
        ethLiquidityAmount,
        fusePool,
        expire
    );
