...
contract OneSplitRoot is IOneSplitView {
    ...
    uint256 constant public DEXES_COUNT = 27;
...
contract OneSplitView is IOneSplitView, OneSplitRoot {
    ...
    function _calculateBalancer(
        ...
        address[] memory pools = balancerRegistry.getBestPoolsWithLimit(address(fromToken), address(destToken), poolIndex + 1);
...
contract OneSplit is IOneSplit, OneSplitRoot {
    ...
    function _swapOnBalancerX(
        ...
        fromToken.universalApprove(pools[poolIndex], amount);
