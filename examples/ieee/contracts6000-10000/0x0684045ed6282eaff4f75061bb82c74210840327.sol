...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function ERC20Token(
        ...
        balances[msg.sender] = 10000000 * (uint256(10) ** 1);               // Give the creator all initial tokens (100000 for example)
        totalSupply = 10000000 * (uint256(10) ** 1);                        // Update total supply (100000 for example)
        name = "iCare Investment Stock";                                   // Set the name for display purposes
        decimals = 1;                            // Amount of decimals for display purposes
        symbol = "IIS";                            // Set the symbol for display purposes
        owner = msg.sender;
    }
