...
contract TradeableERC721Token is ERC721Full, Ownable {
  ...
  event TokenMinted(uint newTokenId);
...
/**
 * @title ARterra NFT
 * ARterra NFT - a contract for my non-fungible sport rewards.
 */
contract ARterraNFT is TradeableERC721Token, ERC721Burnable  {
  constructor(address _proxyRegistryAddress) TradeableERC721Token("ARterraNFT", "OSC", _proxyRegistryAddress) public payable {  }

  function baseTokenURI() public view returns (string memory) {
    return "https://arterra-nft-metadata.herokuapp.com/api/token/metadata/";
  }
  function bulkMint(address[] memory recepients) public {
