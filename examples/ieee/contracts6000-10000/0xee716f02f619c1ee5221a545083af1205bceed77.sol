...
// DARICCOIN Token contract based on the full ERC 20 Token standard
// https://github.com/ethereum/EIPs/issues/20
// Smartcontract for DARICCOIN
// Symbol: DRCC
// Status: ERC20 Verified

contract DARICCOINToken { 
...
/**
 * DARICCOINToken Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract DrccStandardToken is DARICCOINToken, Ownable {
    
    using DRCCMaths for uint256;
...
contract DARICCOIN is DrccStandardToken {
    ...
    */
    ...
    uint256 constant public decimals = 0; //How many decimals to show.
    uint256 public totalSupply = 100000000000 ; 
    string constant public name = "Daric Coin"; //fancy name: eg DARICCOIN
    string constant public symbol = "DRCC"; //An identifier: eg DRCC
