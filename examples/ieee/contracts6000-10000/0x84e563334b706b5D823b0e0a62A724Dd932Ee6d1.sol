...
contract SavingsManager is ISavingsManager, PausableModule {
    ...
    // Logs at which last collection was made
    mapping(address => SupplyLog) public recentSupplyLog; // neg 0-24 hours from now
    mapping(address => SupplyLog) public benchmarkSupplyLog; // neg 24-x hours from now
    ...
    ****************************************/
        ...
        whenNotPaused
    {
        ...
        // 2. If > 24 hours since last log, add a new one
        ...
        if(interestCollected > 0) {
            ...
            // Seconds since benchmark log (> 24 hours ago)
