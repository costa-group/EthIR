...
| $$ \  $$|  $$$$$$$|  $$$$$/$$$$/      | $$  | $$|  $$$$$$/| $$  | $$|  $$$$$$$ /$$$$$$$/  |  $$$$/         | $$| $$      |  $$$$$$$|  $$$$$$$
|__/  \__/ \_______/ \_____/\___/       |__/  |__/ \______/ |__/  |__/ \_______/|_______/    \___/           |__/|__/       \_______/ \_______/
...
contract NewHonestTreeGame  is ERC20, ReentrancyGuard, Ownable{
    ...
    constructor(address _root_node) ERC20("Honest Tree Token", "HTT") public{
        ...
        // We had to stop the old smart contract due to a problem with uint32 / uint256 transformation. 
        // Here we write all the history again
