...
/*
 * EcnToken is a standard ERC20 token with some additional functionalities:
...
contract EcnToken is StandardToken, BurnableToken, Ownable {
	string public constant symbol = "ECN";
	string public constant name = "EtherChain";
	...
	* @param value Amount of ecntokens to send
	*/
