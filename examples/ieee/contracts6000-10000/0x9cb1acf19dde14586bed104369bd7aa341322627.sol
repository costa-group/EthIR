...
contract BlackList is Ownable, BasicToken {
    ...
    /////// Getters to allow the same blacklist to be used also by other contracts (including upgraded FAST) ///////
...
contract FASTToken is Pausable, StandardToken, BlackList {
    ...
    function FASTToken(uint _initialSupply, string _name, string _symbol, uint _decimals) public {
