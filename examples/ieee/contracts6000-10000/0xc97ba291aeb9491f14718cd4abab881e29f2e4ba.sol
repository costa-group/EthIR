...
contract TendiesFarm is ERC20, ERC20Detailed, Ownable, ReentrancyGuard {
    ...
    uint256 private _burnFeeRate = 1;
    ...
    function burn(uint256 amount) public nonReentrant {
        ...
        _feesCollected = getFeesCollected().add(_fee);
    }
    ...
    function getTotalStakedTendies() public view returns (uint256 total) {
        total = TEND.balanceOf(address(this)).sub(getFeesCollected());
    }
    ...
    function getFeesCollected() public view returns (uint256 collected) {
    ...
    function withdrawFees() external onlyOwner {
        TEND.safeTransfer(owner(), getFeesCollected());
        _feesCollected = 0;
    }
}