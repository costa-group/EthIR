...
contract PausableToken is BasicToken, ERC20Detailed, Pausable, ERC20Burnable, Mintable {
    string public constant NAME = "VICTOR-K";
    string public constant SYMBOL = "VCT-K";
  ...
  */
    ...
    constructor () public ERC20Detailed("VICTOR-K", "VCT-K", 8) {
      
         _mint(0xAB4f0AaAf747CeFB015D7E21C498aB1f63a06D48, 10000000000 * (10 ** uint256(decimals())));
    } 
}