...
contract flashIt{
    ...
    function setParams(string memory _mtoken, string memory _ex0, string memory _ex1, string memory _ex2) public onlyOwner {
    ...
    function arbTrade(uint256 _amount, string memory _mtoken, string memory _ex0, string memory _ex1, string memory _ex2) public onlyOwner {
        string[] memory tokenOrder = new string[](3);
        string[] memory exchangeOrder = new string[](3);
        OrFeedInterface orfeed= OrFeedInterface(0x8316b082621cfedab95bf4a44a1d4b64a6ffc336);
