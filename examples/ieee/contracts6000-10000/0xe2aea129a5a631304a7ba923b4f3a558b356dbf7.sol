...
contract DSSRegistry is DSSExtensionCreator,IDSSRegistry,ERC721Burnable {
    ...
    // keccak256(abi.encodePacked(uint256(0x0), keccak256(abi.encodePacked("blockchains-domain"))))
