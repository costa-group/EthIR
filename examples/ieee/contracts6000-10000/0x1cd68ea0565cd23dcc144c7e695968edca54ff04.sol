...
abstract contract AccessControl is Context {
    ...
    function transferAdmin(address account) public virtual {
...
contract WMARTK is Context, AccessControl, ERC20, Pausable {
    ...
    function pause() public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "ERC20: Only ADMIN can pause");
        _pause();
    }

    function unpause() public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "ERC20: Only ADMIN can unpause");
        _unpause();
    }   
