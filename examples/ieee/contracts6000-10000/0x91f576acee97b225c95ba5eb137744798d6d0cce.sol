...
contract ExchangeVMR is Initializable
{
    ...
    function initialize() initializer public {
        tokenAddressVMR = address(0x063b98a414EAA1D4a5D4fC235a22db1427199024);
    ...
    function calcAmountTokens(uint256 amountEther) view public returns (uint256) {
        return amountEther.mul(10**18).div(main.getTokenRate(tokenAddressVMR));
    }
