...
contract BlackList is Ownable, BasicToken {
    ...
    /////// Getters to allow the same blacklist to be used also by other contracts (including upgraded NRC) ///////
...
contract NRCToken is Pausable, StandardToken, BlackList {
    ...
    function NRCToken(uint _initialSupply, string _name, string _symbol, uint _decimals) public {
