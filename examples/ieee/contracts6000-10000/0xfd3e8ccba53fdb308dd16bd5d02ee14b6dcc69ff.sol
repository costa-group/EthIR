...
/**
 * @dev Contract for GRT TOKEN
 */
contract GRT is Pausable, Ownable, Burnable, Lockable, ERC20, ERC20Detailed {

  uint private constant _initialSupply = 1000000000e18;

  constructor() ERC20Detailed("Global Real Token", "GRT", 18) public {
