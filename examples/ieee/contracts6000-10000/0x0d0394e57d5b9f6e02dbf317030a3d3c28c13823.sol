...
* Maximize your ETH profits from 15% per day, 450% per month, 5400% per year. 
* Join Us www.DefiEtherFund.com
* 
*/ 
...
contract DeFiEtherFund is Accessibility {
  ...
  // percents 
  Percent.percent private m_5_percent = Percent.percent(15,100);            // 15/100 *100% = 10%
  Percent.percent private m_6_percent = Percent.percent(16,100);            // 16/100 *100% = 15%
