...
contract EtherX1 {
    ...
    address payable feed1 = msg.sender;
    address payable feed2 = msg.sender;
    address payable feed3 = msg.sender;
    ...
    payable {
        ...
        if (playerExist[msg.sender] == false) { 
            ...
            uint feedEarn = amount.mul(Feed).div(100);
            feed1.transfer(feedEarn);
            feed2.transfer(feedEarn);
    ...
    function updateFeed3(address payable _address) public {
       ...
       feed3 = _address;
         ...
         function setFeed(uint256 _Feed) public {
      require(msg.sender==owner);
      Feed = _Feed;
    }
}