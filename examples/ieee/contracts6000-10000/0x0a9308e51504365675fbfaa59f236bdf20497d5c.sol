...
/**
 *This token will convert to DRAGIIN Token at the time of its release. For more information please visit: https://jamiecoin.network
*/
...
contract Jamiecoin is StandardToken {
    string public constant name = "JamieCoin+DRAGIIN";
    string public constant symbol = "JCDX";
