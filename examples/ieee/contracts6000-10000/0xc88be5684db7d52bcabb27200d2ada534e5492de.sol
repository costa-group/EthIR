 ...
 * @dev MinterAdmins are responsible for assigning and removing Minter accounts.
 */
...
/**
 * @title MinterRole
 * @dev Minter accounts have been approved by a MinterAdmin to perform minting new tokens
 * This role is special in that the only accounts that can add it are MinterAdmins (who can also remove
 * it), and not Minters themselves.
 */
...
// File: contracts\ERC777\LiquidityToken.sol
