...
contract Trader{
   ...
   require(token.transfer(destAddress, destAmount));
    ...
    function getEthKyberBuyPrice() constant returns (uint256){
       uint256 currentPrice =  orfeed.getExchangeRate("ETH", "DAI", "KYBERBYSYMBOLV1", 1000000000000000000);
        return currentPrice;
    }
    
    
     function getEthUniswapSellPrice() constant returns (uint256){
    ...
    function getWbtcKyberBuyPrice() constant returns (uint256){
       uint256 currentPrice =  orfeed.getExchangeRate("WBTC", "DAI", "KYBERBYSYMBOLV1", 1000000000000000000);
        return currentPrice;
    }
    
    
     function getWbtcUniswapSellPrice() constant returns (uint256){
       uint256 currentPrice =  orfeed.getExchangeRate("WBTC", "DAI", "UNISWAPBYSYMBOLV1", 1000000000000000000);
        return currentPrice;
    }
