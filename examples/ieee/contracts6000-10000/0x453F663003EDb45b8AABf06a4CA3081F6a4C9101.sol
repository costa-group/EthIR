...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Samael";
    string public constant TOKEN_SYMBOL = "SML";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x90d470667536CfDF5E71e035D7e44D270E1d0dDf;
    
    uint public constant START_TIME = 1591344000;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[1] memory weiRaisedStartsBounds = [uint(10000000000000000000000)];
        uint[1] memory weiRaisedEndsBounds = [uint(10004565600000000000000)];
        uint64[1] memory timeStartsBounds = [uint64(1591344000)];
        uint64[1] memory timeEndsBounds = [uint64(1593640800)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(10000 * TOKEN_DECIMAL_MULTIPLIER, 0x90d470667536CfDF5E71e035D7e44D270E1d0dDf, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1601067600)
        CappedCrowdsale(100000000000000000000000000)
    ...
    function init() public onlyOwner {
        ...
        address[3] memory addresses = [address(0x90d470667536cfdf5e71e035d7e44d270e1d0ddf),address(0x90d470667536cfdf5e71e035d7e44d270e1d0ddf),address(0x90d470667536cfdf5e71e035d7e44d270e1d0ddf)];
        uint[3] memory amounts = [uint(2500000000000000000000000),uint(20000000000000000000000000),uint(15000000000000000000000000)];
        ...
        internal
    {
        ...
        require(msg.value <= 500000000000000000000000);
