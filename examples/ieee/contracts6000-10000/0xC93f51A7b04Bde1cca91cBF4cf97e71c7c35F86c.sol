...
contract Consts {
    ...
    string public constant TOKEN_NAME = "UNIFI";
    string public constant TOKEN_SYMBOL = "UNIFI";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x55269F46ff17ADC6B46df226BcD74B50380b6512;
    
    uint public constant START_TIME = 1597795228;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[2] memory weiRaisedEndsBounds = [uint(4500000000000000000000),uint(4500000000000000000000)];
        uint64[2] memory timeStartsBounds = [uint64(1597795228),uint64(1598079540)];
        uint64[2] memory timeEndsBounds = [uint64(1598079540),uint64(1598252340)];
        uint[2] memory weiRaisedAndTimeRates = [uint(250),uint(150)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(10000 * TOKEN_DECIMAL_MULTIPLIER, 0x9c27FD822F05De31080B7394A99fBCB9F0Cf0C0b, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1598338740)
        CappedCrowdsale(4500000000000000000000)
