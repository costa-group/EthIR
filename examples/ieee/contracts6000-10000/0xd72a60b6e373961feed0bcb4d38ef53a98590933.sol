...
contract Ownable {
  ...
  constructor() public {
    owner = msg.sender;
    manager = msg.sender;
    ownerWallet = 0xf84000A9893414A4E97659327b12575B759f51ee;
  }
...
contract MileWallet is Ownable {
    ...
    constructor() public {
        ...
        LEVEL_PRICE[2] = 0.30 ether;
        LEVEL_PRICE[3] = 0.90 ether;
        LEVEL_PRICE[4] = 2.70 ether;
        LEVEL_PRICE[5] = 8.10 ether;
        LEVEL_PRICE[6] = 24.30 ether;
        LEVEL_PRICE[7] = 72.90 ether;
        LEVEL_PRICE[8] = 218.70 ether;
