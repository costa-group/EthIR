...
contract ImportResolver is ImportHelper {
    ...
    */
        ...
        payable
    {
        ...
        bytes32 _eventCode = keccak256("LogMigrate(address,uint256,address[],uint[],uint[])");
        bytes memory _eventParam = abi.encode(userAccount, tokens, times);
...
contract ConnectCompoundImport is ImportResolver {
    string public name = "Compound-Import-v1";
}