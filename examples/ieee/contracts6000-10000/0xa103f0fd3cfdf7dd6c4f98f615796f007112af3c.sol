...
contract POEAToken is ERC20Pausable, ERC20Burnable, ERC20Mintable, MultiTransferToken {
  string public constant name = "Philippine Overseas Employment Administration";
  string public constant symbol = "POEA";
