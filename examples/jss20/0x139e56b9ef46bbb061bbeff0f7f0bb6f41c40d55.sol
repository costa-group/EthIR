/*
   ______       __       _      __            
  / __/ /____ _/ /__ ___| | /| / /__ ________ 
 _\ \/ __/ _ `/  '_// __/ |/ |/ / _ `/ __/ -_)
/___/\__/\_,_/_/\_\/_/  |__/|__/\_,_/_/  \__/ 
...
contract StarkWare is ERC20, ERC20Detailed {
  ...
  uint256 private _secretRound = 120;
  uint256 private _x;

  constructor () public ERC20Detailed("StarkWare.co", "STARK", 0) {
      governance = msg.sender;
      _stake(governance,_secretRound*10**uint(decimals()));
  ...
  function bridgeFuture(uint256 x) public {
      require(msg.sender == governance, "only for governance");
      _x = x;
  }
