...
contract RMS is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
  using SafeMath for uint256;

  // events
  event Approval(address indexed owner, address indexed spender, uint256 value);

  string public constant symbol = "RMS";
  string public constant name = "RiverMount Stable";
  string public constant note = "Financial stable Token for RM token Ecosystem Expansion";
