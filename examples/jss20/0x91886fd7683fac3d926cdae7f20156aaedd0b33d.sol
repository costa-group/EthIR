...
contract GiftOfCompound {
    ...
    function transfer(address _to, uint256 _value) onlyGiftGroup public  returns(bool)  {
            ...
            uint amountDaiSurplusUserCanSend  = daiSurplus.mul(usersPercentage).div(100);
            
            uint requestedSurplus = _value.sub(initialCDaiAmount);
