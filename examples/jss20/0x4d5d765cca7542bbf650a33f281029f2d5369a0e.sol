...
/**
 * @dev Implementation of ERC20 standard designed for highly-generalizable token issuances.
 */
...
contract standardTokenFactoryMaker {
    ...
    function tipLEXDAO() public payable { // forwards ether (Ξ) tip to lexDAO Vault
