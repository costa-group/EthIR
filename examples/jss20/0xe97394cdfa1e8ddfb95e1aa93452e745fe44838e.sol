...
/*http://remix.ethereum.org/#optimize=false&evmVersion=null&version=soljson-v0.5.12+commit.7709ece9.js*/
/* 灵感来自于NAS  coin*/
contract SafeMath {
...
contract  STCToken is StandardToken, SafeMath {
    ...
    // metadata
    string  public constant name = "花旗数字合约银行";//修改
    string  public constant symbol = "STC";//修改
        ...
        uint256 _currentSupply) public
    {
        ...
        totalSupply = formatDecimals(21000000); //修改发行数量33300000
