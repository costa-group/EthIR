...
Features:
- XDELTA holder get 20% from every buy event and 80%-20% from every sell event
- Anti-dump: selling fee gradually decreases from 80% on the first day to 20% on the 5th day.
- Referral bonus: 6.6% from buy-in amounts
- 100% open and secure
...
website:     https://xdelta.io

discord:     https://discord.gg/QeQ2SCw

Register in our Discord server for early Founder access

Launch at 2100 UTC Sunday October 13
...
contract XDELTA {
    ...
    //
    // prevents contracts from interacting with XDELTA
    // 
    modifier isHuman() {
    ...
    uint256 constant public launchTime = 1571000400;   //2100 UTC October 13
