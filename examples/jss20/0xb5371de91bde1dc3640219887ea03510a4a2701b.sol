...
contract DharmaSmartWalletImplementationV8Staging is
  ...
  function tradeEthForDaiAndMintDDai(
    ...
    // Ensure that an amount of at least 0.001 Ether has been supplied.
    require(ethToSupply > _JUST_UNDER_ONE_1000th_DAI, _revertReason(0)); // TODO: update revert reason

    // Ensure that an amount of at least 0.001 Dai will be received.
    require(minimumDaiReceived > _JUST_UNDER_ONE_1000th_DAI, _revertReason(0));
  ...
  function _tradeEthForDaiAndMintDDaiAtomic(
    ...
    require(daiReceived >= minimumDaiReceived); // TODO: revert reason
