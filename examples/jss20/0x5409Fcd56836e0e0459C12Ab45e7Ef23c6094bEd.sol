...
contract RedExchange {
   ...
   /*================================
    ...
    // Special Red Street Platform control from scam game contracts on Red Street platform
    mapping(address => bool) public canAcceptTokens_; // contracts, which can accept XRED tokens

    mapping(address => address) public stickyRef;

     address public bondFundAddress = 0xbc02f77cc33b705cf1f961dc2859bc0fc1805eca;   //Bond Fund
     address public altFundAddress = 0xbc02f77cc33b705cf1f961dc2859bc0fc1805eca;    //Alternate Fund for Future Game
    ...
    */
    ...
    /**
     * Sends Bond Fund ether to the bond contract
     * 
     */
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check that contract approved by Red Street Exchange platform
    ...
    /**
     * Add or remove game contract, which can accept Red Street Market tokens
     */
...
function purchaseTokens(uint256 _incomingEthereum, address _referredBy)   //NEW
