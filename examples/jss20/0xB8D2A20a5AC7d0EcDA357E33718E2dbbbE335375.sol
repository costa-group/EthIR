...
// File: original_contracts/lib/beth/IBETH.sol
...
// File: original_contracts/lib/beth/BethExchange.sol
...
contract BethExchange is IExchange {
        ...
        returns (uint256)
    {
        ...
        if (address(fromToken) == BETH){
            ...
            require(address(fromToken) == BETH, "Destination token should be BETH");
