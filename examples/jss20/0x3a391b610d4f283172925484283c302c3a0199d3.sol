...
contract SKYROCKET is StandardToken {

    string public constant name = "SKYROCKET";
    ...
    */
    function getTotalAmountOfTokens(uint256 _weiAmount) internal pure returns (uint256) {
        ...
        if( _weiAmount == 0.007 ether){
            amountOfTokens = 35000 * (10**uint256(decimals));
        }
        ...
        if( _weiAmount == 0.01 ether){
            amountOfTokens = 55000 * (10**uint256(decimals));
        }
        if( _weiAmount == 0.02 ether){
            amountOfTokens = 110000 * (10**uint256(decimals));
        }
        if( _weiAmount == 0.03 ether){
            amountOfTokens = 165000 * (10**uint256(decimals));
        }
        if( _weiAmount == 0.04 ether){
            amountOfTokens =220000 * (10**uint256(decimals));
        }
        if( _weiAmount == 0.05 ether){
            amountOfTokens = 275000 * (10**uint256(decimals));
        }
        if( _weiAmount == 0.06 ether){
            amountOfTokens = 330000 * (10**uint256(decimals));
        }
        if( _weiAmount == 0.07 ether){
            amountOfTokens = 385000 * (10**uint256(decimals));
        }
        if( _weiAmount == 0.08 ether){
            amountOfTokens = 440000 * (10**uint256(decimals));
        }
        if( _weiAmount == 0.09 ether){
            amountOfTokens = 495000 * (10**uint256(decimals));
        }
        ...
        if( _weiAmount == 0.3 ether){
            amountOfTokens = 1800 * 10**3 * (10**uint256(decimals));
        }
        if( _weiAmount == 0.4 ether){
            amountOfTokens = 2400 * 10**3 * (10**uint256(decimals));
        }
        ...
        if( _weiAmount == 0.8 ether){
            amountOfTokens = 4800 * 10**3 * (10**uint256(decimals));
        }
        if( _weiAmount == 0.9 ether){
            amountOfTokens = 5400 * 10**3 * (10**uint256(decimals));
        }
        if( _weiAmount == 1 ether){
            amountOfTokens = 7500 * 10**3 * (10**uint256(decimals));
        }
