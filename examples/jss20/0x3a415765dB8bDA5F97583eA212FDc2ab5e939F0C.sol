...
// File: contracts/O2ocTokenToken.sol

pragma solidity ^0.4.18;


contract O2ocTokenToken is PausableToken {

    string  public  constant name = "O2O Global Platform";
    string  public  constant symbol = "O2OC";
    uint8   public  constant decimals = 18;

    mapping(address => uint) approvedInvestorListWithDate;

    function O2ocTokenToken( address _admin, uint256 _totalTokenAmount )
    {
        admin = _admin;
