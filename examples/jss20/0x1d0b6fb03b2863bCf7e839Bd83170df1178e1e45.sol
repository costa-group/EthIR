...
contract AMWSWToken is Initializable, ERC20Detailed, ERC20Mintable, ERC20Pausable, ERC20Rewardable {
    ...
    function initialize() public initializer {
        Token_ID = "AMWSW";
        ArtistID = "Luke Tsui, Steven Lin, Jae Chong";
        ISRC = "";

        ERC20Detailed.initialize("", "AMWSW", 18);
