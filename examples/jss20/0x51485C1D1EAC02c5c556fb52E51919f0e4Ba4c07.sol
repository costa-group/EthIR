...
contract JZYKSToken is Initializable, ERC20Detailed, ERC20Mintable, ERC20Pausable, ERC20Rewardable {
    ...
    function initialize() public initializer {
        Token_ID = "JZYKS";
        ArtistID = "Enik Lin, Nicky Lee";
        ISRC = "";

        ERC20Detailed.initialize("", "JZYKS", 18);
