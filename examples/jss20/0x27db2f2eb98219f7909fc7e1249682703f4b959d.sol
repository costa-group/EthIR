/*
 ...
 ___ ___   ___  __    __  _   _   _       _  ___       __ 
  |   |     |  (_    (_  |_) |_) |_  /\  | \  |  |\ | /__ 
...
*
* 33% Dividends:
* - Distributed to COVID carriers proportional to the total COVID circulating supply
* 
* Real Masternode Referrals:
* - Receive 11.1% of the total transaction (30% of the 33% generated dividends)
*
* A Viral Version of the Original Ethereum Pyramid:
...
contract COVID {
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "COVID 19";
    string public symbol = "COVID";
