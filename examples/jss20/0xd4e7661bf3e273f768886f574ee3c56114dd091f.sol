...
@public
@constant
def salescontract() -> address:
    return self.itocontract

@public
def appointIssuer(_to : address, _value : bool):
...
@public
def setSaleContract(_to : address, _value : bool):
    """
