...
contract UniswapAPR is Ownable {
    ...
    function getCDAIUniROI() public view returns (uint256) {
      return calcUniswapROI(CDAI);
    }
    function getCBATUniROI() public view returns (uint256) {
      return calcUniswapROI(CBAT);
    }
    function getCETHUniROI() public view returns (uint256) {
      return calcUniswapROI(CETH);
    }
    function getCREPUniROI() public view returns (uint256) {
      return calcUniswapROI(CREP);
    }
    function getCSAIUniROI() public view returns (uint256) {
      return calcUniswapROI(CSAI);
    }
    function getCUSDCUniROI() public view returns (uint256) {
      return calcUniswapROI(CUSDC);
    }
    function getCWBTCUniROI() public view returns (uint256) {
      return calcUniswapROI(CWBTC);
    }
    function getCZRXUniROI() public view returns (uint256) {
      return calcUniswapROI(CZRX);
    }


    function getIZRXUniROI() public view returns (uint256) {
      return calcUniswapROI(IZRX);
    }
    function getIREPUniROI() public view returns (uint256) {
      return calcUniswapROI(IREP);
    }
    function getIKNCUniROI() public view returns (uint256) {
      return calcUniswapROI(IKNC);
    }
    function getIWBTCUniROI() public view returns (uint256) {
      return calcUniswapROI(IWBTC);
    }
    function getIUSDCUniROI() public view returns (uint256) {
      return calcUniswapROI(IUSDC);
    }
    function getIETHUniROI() public view returns (uint256) {
      return calcUniswapROI(IETH);
    }
    function getISAIUniROI() public view returns (uint256) {
      return calcUniswapROI(ISAI);
    }
    function getIDAIUniROI() public view returns (uint256) {
      return calcUniswapROI(IDAI);
    }
    function getILINKUniROI() public view returns (uint256) {
      return calcUniswapROI(ILINK);
    }
    function getISUSDUniROI() public view returns (uint256) {
      return calcUniswapROI(ISUSD);
    }

    function getADAIUniROI() public view returns (uint256) {
      return calcUniswapROI(ADAI);
    }
    function getATUSDDUniROI() public view returns (uint256) {
      return calcUniswapROI(ATUSD);
    }
    function getAUSDCUniROI() public view returns (uint256) {
      return calcUniswapROI(AUSDC);
    }
    function getAUSDTUniROI() public view returns (uint256) {
      return calcUniswapROI(AUSDT);
    }
    function getASUSDUniROI() public view returns (uint256) {
      return calcUniswapROI(ASUSD);
    }
    function getALENDUniROI() public view returns (uint256) {
      return calcUniswapROI(ALEND);
    }
    function getABATUniROI() public view returns (uint256) {
      return calcUniswapROI(ABAT);
    }
    function getAETHUniROI() public view returns (uint256) {
      return calcUniswapROI(AETH);
    }
    function getALINKUniROI() public view returns (uint256) {
      return calcUniswapROI(ALINK);
    }
    function getAKNCUniROI() public view returns (uint256) {
      return calcUniswapROI(AKNC);
    }
    function getAREPUniROI() public view returns (uint256) {
      return calcUniswapROI(AREP);
    }
    function getAMKRUniROI() public view returns (uint256) {
      return calcUniswapROI(AMKR);
    }
    function getAMANAUniROI() public view returns (uint256) {
      return calcUniswapROI(AMANA);
    }
    function getAZRXUniROI() public view returns (uint256) {
      return calcUniswapROI(AZRX);
    }
    function getASNXUniROI() public view returns (uint256) {
      return calcUniswapROI(ASNX);
    }
    function getAWBTCUniROI() public view returns (uint256) {
      return calcUniswapROI(AWBTC);
    }

    function getDAIUniROI() public view returns (uint256) {
      return calcUniswapROI(DAI);
    }
    function getTUSDDUniROI() public view returns (uint256) {
      return calcUniswapROI(TUSD);
    }
    function getUSDCUniROI() public view returns (uint256) {
      return calcUniswapROI(USDC);
    }
    function getUSDTUniROI() public view returns (uint256) {
      return calcUniswapROI(USDT);
    }
    function getSUSDUniROI() public view returns (uint256) {
      return calcUniswapROI(SUSD);
    }
    function getLENDUniROI() public view returns (uint256) {
      return calcUniswapROI(LEND);
    }
    function getBATUniROI() public view returns (uint256) {
      return calcUniswapROI(BAT);
    }
    function getETHUniROI() public view returns (uint256) {
      return calcUniswapROI(ETH);
    }
    function getLINKUniROI() public view returns (uint256) {
      return calcUniswapROI(LINK);
    }
    function getKNCUniROI() public view returns (uint256) {
      return calcUniswapROI(KNC);
    }
    function getREPUniROI() public view returns (uint256) {
      return calcUniswapROI(REP);
    }
    function getMKRUniROI() public view returns (uint256) {
      return calcUniswapROI(MKR);
    }
    function getMANAUniROI() public view returns (uint256) {
      return calcUniswapROI(MANA);
    }
    function getZRXUniROI() public view returns (uint256) {
      return calcUniswapROI(ZRX);
    }
    function getSNXUniROI() public view returns (uint256) {
      return calcUniswapROI(SNX);
    }
    function getWBTCUniROI() public view returns (uint256) {
      return calcUniswapROI(WBTC);
    }

    function calcUniswapROI(address token) public view returns (uint256) {
        ...
        return ethBalance.mul(1000).div(totalShares);
    }
