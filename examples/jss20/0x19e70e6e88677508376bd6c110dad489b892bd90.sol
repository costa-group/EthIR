...
contract LvchainToken is SafeMath {
  string public name;
  ...
  function LvchainToken() {
    ...
    name = 'Lvchain Token';                         // Set the name for display purposes
    symbol = 'Lvchain';                             // Set the symbol for display purposes
