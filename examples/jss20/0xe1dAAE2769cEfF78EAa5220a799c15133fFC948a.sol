...
contract Consts {
    ...
    string public constant TOKEN_NAME = "DeFiLend Protocol";
    string public constant TOKEN_SYMBOL = "DFN";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x27CFB92064326327e88BE61fF960a18f343C1438;
    
    uint public constant START_TIME = 1598623200;
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(4129 * TOKEN_DECIMAL_MULTIPLIER, 0x27CFB92064326327e88BE61fF960a18f343C1438, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1598709600)
        CappedCrowdsale(968757568418503269557)
        
        RefundableCrowdsale(121094696052312908695)
    ...
    function init() public onlyOwner {
        ...
        address[5] memory addresses = [address(0x4546cdd0b62c3b032abc30aae53f8b36e500f895),address(0xec0ca3f116fa8d3b75ecbd0dc5281b84f8273fc2),address(0x509603e40f6a04759af693579909e018b40675cf),address(0x66bfbe185a34efec60eb8fdb46e718cf406ac852),address(0xd057eb24a50846d0b9a21addafcd9d1cb686c7b3)];
        uint[5] memory amounts = [uint(400000000000000000000000),uint(1600000000000000000000000),uint(1800000000000000000000000),uint(1000000000000000000000000),uint(1200000000000000000000000)];
        uint64[5] memory freezes = [uint64(1606258801),uint64(1606258801),uint64(1606258801),uint64(1606258801),uint64(1606258801)];
