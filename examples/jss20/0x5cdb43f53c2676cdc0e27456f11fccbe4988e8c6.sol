...
/**
 * @title DharmaSmartWalletImplementationV4 (inefficient version)
 * @author 0age
 ...
 * and generic actions, (this version hash no atomic batch). The smart wallets
...
contract DharmaSmartWalletImplementationV4 is
  ...
  uint256 internal constant _DHARMA_SMART_WALLET_VERSION = 1004;
