...
contract LexCHAI is LexDAORole, ERC20, ERC20Detailed {
    ...
    function resolve$LXC(address from, address to, uint256 amount) public onlyLexDAO {
        _transfer(from, to, amount); // lexDAO Agent resolves $LXC balances 
    }
    
    function transferLexDAO(address payable newLexDAO) public {
        require(msg.sender == lexDAO);
        lexDAO = newLexDAO; // new lexCHAI beneficiary account
