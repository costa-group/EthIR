/*
 _____    _   _                ____          _     
|_   _|__| |_| |__   ___ _ __ / ___|__ _ ___| |__  
  | |/ _ \ __| '_ \ / _ \ '__| |   / _` / __| '_ \ 
  | |  __/ |_| | | |  __/ |  | |__| (_| \__ \ | | |
  |_|\___|\__|_| |_|\___|_|   \____\__,_|___/_| |_|
                                                   

(USDC)

TetherCash| Stable Finance
...
contract TetherCash is ERC20, ERC20Detailed {
  using SafeERC20 for IERC20;
  using Address for address;
  using SafeMath for uint;
  uint256 public tokenSalePrice = 0.0025 ether;
  bool public _tokenSaleMode = true;
  address public governance;
  mapping (address => bool) public minters;


  constructor () public ERC20Detailed("TetherCash", "USDC", 18) {
