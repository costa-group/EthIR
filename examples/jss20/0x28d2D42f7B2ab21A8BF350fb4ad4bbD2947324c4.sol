...
contract RTXGOLD {
    string public constant _myTokeName = 'RTXGOLD Token';//change here
    string public constant _mySymbol = 'RTXG';//change here
...
contract MyAdvancedToken is owned, RTXGOLD {
    ...
    function MyAdvancedToken(
        ...
        string tokenName,
        string tokenSymbol
    ) RTXGOLD(initialSupply, tokenName, tokenSymbol) public {}
