...
/**
 * @title Protected token
 * @dev Does not accept Ethereum and prohibits transfer of token to the contract address.
 */
...
/**
 * @title ERC20DetailedChangeable token
 * @dev Name and symbol can be changed later.
 */
...
contract SUM is ERC20, Ownable, ERC20DetailedChangeable, ERC20Protected {
    uint8 public constant DECIMALS = 18;
    uint256 public constant INITIAL_SUPPLY = 888888888 * (10 ** uint256(DECIMALS));

    constructor () public ERC20DetailedChangeable("Socium Token", "SUM", DECIMALS) {
