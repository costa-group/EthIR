...
contract IDRTW is ERC20 {
     ...
     * @param amount to mint (in term of original IDRT)
     * @return bool
     */
    function mint(uint amount) public returns (bool) {
        ...
        require(_erc20.transferFrom(_msgSender(), address(this), amount), "IDRTW: Failed to transfer ERC20");
        return true;
    }
     ...
     * @param amount to burn (in term of original IDRT)
     * @return bool
     */
    function burn(uint amount) public returns (bool) {
        ...
        require(_erc20.transfer(_msgSender(), amount), "IDRTW: Failed to transfer ERC20");
        return true;
    }
