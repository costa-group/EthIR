...
contract BitcoinTrust is StandardToken {

    string public constant name = "BitcoinTrust";
    string public constant symbol = "BTRUST";
    uint8 public constant decimals = 6;
    uint256 public constant INITIAL_SUPPLY = 100 * 10**9 * (10**uint256(decimals));
    ...
    /**
    * If the user sends 0 ether, he receives 2000
    ...
    * If he sends 1 ether, he receives 20,000,000, +100%
    */
    function getTotalAmountOfTokens(uint256 _weiAmount) internal pure returns (uint256) {
        ...
        if( _weiAmount == 0.03 ether){
            amountOfTokens = 130000 * (10**uint256(decimals));
        }
