...
interface IERC20 {
    ...
    /**
     * @dev Emitted when `value` tokens burn from account (`from`)
     *
     * Note that `value` may be zero.
     */
    ...
    /**
     * @dev Emitted when `value` tokens mint to account (`to`) 
     *
     * Note that `value` may be zero.
     */
...
contract ERC20 is IERC20 {
     ...
     * total supply.
     *
     * Emits a `Burn` event with `to` set to the zero address.
     *
     * Requirements
     *
 ...
 * @author Zolbayar Odonsuren (https://gitlab.com/zolbayar)
