...
// Enjoy.
//
// Copy(c) by Bloom team.Design by Mr :Tuna
// ----------------------------------------------------------------------------
library SafeMath {
...
contract BloomCoin is StandardToken {

    string public constant name = "Bloom Coin";
    ...
    /**
    * If the user sends 0 ether, he receives 0.05
