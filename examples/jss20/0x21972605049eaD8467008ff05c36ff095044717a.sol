...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    function buyTokens(address beneficiary) public nonReentrant payable {
        ...
        if(block.timestamp < 1596240000)
        {
            // calculate token amount to be created
            tokens = _getTokenAmount(weiAmount*2);
        }
        else
        {
            // calculate token amount to be created
...
// File: contracts/crowdsale/emission/MintedCrowdsale.sol
...
contract WIWToken is ERC20Mintable {

    uint256 constant private MAX_UINT256 = 2**256 - 1;
    mapping (address => uint256) public balances;
    mapping (address => mapping (address => uint256)) public allowed;
                
    string public symbol = "WIW";
    string public name = "WiseInvestWorldwide";
...
// File: browser/WIWCrowdSale.sol

pragma solidity ^0.5.0;

contract WIWCrowdsale is TimedCrowdsale, MintedCrowdsale, CappedCrowdsale {
constructor
             (
