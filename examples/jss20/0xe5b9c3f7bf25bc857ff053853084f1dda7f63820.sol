...
contract CurveFlash is ReentrancyGuard, Ownable, Structs {
  ...
  function callFunction(
    ...
    OneSplit(one).goodSwap(dai, usdt, IERC20(dai).balanceOf(address(this)), 1, 4, DISABLED);
    OneSplit(one).goodSwap(usdt, dai, IERC20(usdt).balanceOf(address(this)), 1, 4, DISABLED);
