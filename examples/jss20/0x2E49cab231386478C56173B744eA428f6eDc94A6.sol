...
// File: contracts/exchange_handlers/interfaces/zeroex/LibOrderV3.sol
    ...
    */
      ...
      returns (uint256 amountToGive)
    {
        ...
        uint maxFromMakerFee = data.makerFee == 0 ? Utils.max_uint() : getPartialAmount(
            getAssetDataAvailable(data.makerFeeAssetData, data.makerAddress),
            data.makerFee,
        ...
        returns (bool checksPassed)
    {
        ...
        //  We have enough eth to pay the protocol fee
        return (block.timestamp <= data.expirationTimeSeconds &&
                address(this).balance >= PROTOCOL_FEE_CONSTANT*tx.gasprice
        );
    }
