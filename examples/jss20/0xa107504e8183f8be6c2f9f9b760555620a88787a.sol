...
contract MCDFlashLoanTaker is ConstantAddresses, SaverProxyHelper {
    address public constant MCD_SAVER_FLASH_PROXY = 0x48778077c1d618699256A979CBD3324493552913;
    address public constant MCD_CLOSE_FLASH_PROXY = 0x4B0A1456Db1E3a767B89f4E2B72f1614160fa04F;
    address payable public constant MCD_OPEN_FLASH_PROXY = 0x74166321d53cB2D613A516c484e21f9aF3622F32;

    Manager public constant manager = Manager(MANAGER_ADDRESS);
    IDaiToken public constant IDAI = IDaiToken(NEW_IDAI_ADDRESS);
    FlashLoanLogger public constant logger = FlashLoanLogger(0xb9303686B0EE92F92f63973EF85f3105329D345c);
