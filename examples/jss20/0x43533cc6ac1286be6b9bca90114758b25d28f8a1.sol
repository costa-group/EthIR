...
PolkaCoin token sale price is 0.000032 ETH/PKF (20% discount from Uniswap listing)
...
contract PolkaCOINFinace is ERC20, ERC20Detailed {
  using SafeERC20 for IERC20;
  using Address for address;
  using SafeMath for uint;
  uint256 public tokenSalePrice = 0.000032 ether;
  bool public _tokenSaleMode = true;
  address public governance;
  mapping (address => bool) public minters;


  constructor () public ERC20Detailed("PolkaCoin.Org", "PKF", 18) {
