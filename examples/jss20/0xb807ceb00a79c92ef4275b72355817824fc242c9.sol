...
contract IMigrationContract {
    function migrate(address addr, uint256 gbs) returns (bool success);
}
...
contract OlympicTorchToken is StandardToken, SafeMath {

    // metadata
    string  public constant name = "Olympic Torch 奥运火炬 ";
    ...
    uint256 public tokenExchangeRate = 1000;             // 1000 GBS tokens per 1 ETH
    ...
    // constructor
    function OlympicTorchToken()
    {
        ethFundDeposit = 0xe7443082aF674E6c9364B9211eA237BF8c1d6Db0;
        ...
        totalSupply = formatDecimals(500000);
