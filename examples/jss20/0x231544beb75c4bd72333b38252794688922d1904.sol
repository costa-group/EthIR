...
contract SecurityTokenFactoryMaker {
    // presented by OpenEsquire || lexDAO

    SimpleRestrictedFDTFactory private factory;
    
    address[] public factories;
    
    event Deployed(address indexed factory, bool indexed _gated, address indexed deployer);
    
    function newSecurityTokenFactory(string memory _stamp, bool _gated) public {
        factory = new SimpleRestrictedFDTFactory(_stamp, _gated, msg.sender);
