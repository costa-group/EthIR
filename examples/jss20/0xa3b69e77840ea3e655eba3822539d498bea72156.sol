 ...
 *
 * The account that deploys the contract will be granted the minter role and 
 * the default admin role, meaning it will be able to grant the minter roles.
 */
