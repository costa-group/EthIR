...
contract ERC20Token is CrowdsaleCompatible, EditableToken, ThirdPartyTransferableToken {
    ...
    constructor() public
    {
        balanceOf[0x1a08070FFE5695aB0Eb4612640EeC11bf2Cf58eE] = uint256(175000000) * 10**18;
        emit Transfer(address(0x0), 0x1a08070FFE5695aB0Eb4612640EeC11bf2Cf58eE, balanceOf[0x1a08070FFE5695aB0Eb4612640EeC11bf2Cf58eE]);

        transferOwnership(0x1a08070FFE5695aB0Eb4612640EeC11bf2Cf58eE);

        totalSupply = 157000000 * 10**18;                  // Update total supply
        name = 'SPAS 157 Coin';                                   // Set the name for display purposes
        symbol = 'SPAS157';                               // Set the symbol for display purposes
