...
// Btcbabil Token contract based on the full ERC 20 Token standard
// Symbol: BBC
// Status: ERC20 Verified

contract BTCBABILToken { 
...
/**
 * BTCBABIL Token Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract BBCStandardToken is BTCBABILToken, Ownable {
    
    using BBCMaths for uint256;
...
contract BTCBABIL is BBCStandardToken {
    ...
    */
    ...
    string constant public name = "BTCBABIL"; //fancy name: eg  BTCBABIL
    string constant public symbol = "BBC"; //An identifier: eg BBC
