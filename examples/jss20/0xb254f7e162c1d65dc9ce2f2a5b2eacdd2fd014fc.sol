...
contract CypherBank is Ownable{
    ...
    string public name = "Cypher Bank";
    string public symbol = "CBT";
    uint8 constant public decimals = 18;
    uint8 constant internal entryFee_ = 20; //Includes the Dev Game fund & the money alloted for the daily fixed interest. 15% is the actual fee charged for buy.
    uint8 constant internal transferFee_ = 1;
    uint8 constant internal ExitFee_ = 25; 
    uint8 constant internal refferalFee_ = 8;
    uint8 constant internal DevFee_ = 25; //Dev Game fund, This value will be divided by 10 and used. Since we cannot use a decimal here, a round number is used.
    uint8 constant internal DailyInterest_ = 1; 
    uint8 constant internal IntFee_ = 25; //Vault Fund This value will be divided by 10 and used. Since we cannot use a decimal here, a round number is used.
    ...
    address dev = 0xbD4DA497c4F4B035935adb72c65302e6b9b19fd7;
