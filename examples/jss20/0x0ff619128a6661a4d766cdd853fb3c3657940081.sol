...
contract DssProxyActionsLiq is DssProxyHelpers {
    // Public functions
    ...
    function freeLiqEth(uint cdp, uint wad) public {
        address ethJoin = InstaMcdAddress(getMcdAddresses()).ethAJoin();
    ...
    function freeLiqGem(address gemJoin, uint cdp, uint wad) public {
