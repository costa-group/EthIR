/**
*  Farmers Token (FMT) by Mali Limited Partnership
**/
...
/******************************************/
/* FarmersToken (FMT) STARTS HERE         */
/******************************************/

contract Farmerstoken is Authorizable, TokenERC20 {

    using SafeMath for uint256;
    /// Maximum tokens to be allocated on the sale
    uint256 public tokenSaleHardCap;
    /// Base exchange rate is set to 1 ETH = FMT.
   ...
   /// no tokens can be ever issued when this is set to "true"
    ...
    constructor(
        ...
        tokenSaleHardCap =  5000000000 * 10**uint256(decimals); // Default Hard Cap amount with decimals
        baseRate = 100 * 10**uint256(decimals); // Default base rate FMT :1 eth amount with decimals
    }
    ...
    /// @notice Allow users to buy tokens for `newTokenSaleHardCap` FMT
    /// @param newTokenSaleHardCap Amount of FMT token sale hard cap
    ...
    /// @dev Compute the amount of FMT token that can be purchased.
    /// @param ethAmount Amount of Ether in WEI to purchase FMT.
    /// @return Amount of FMT token to purchase
