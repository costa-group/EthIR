...
contract JZTCToken is Initializable, ERC20Detailed, ERC20Mintable, ERC20Pausable, ERC20Rewardable {
    ...
    function initialize() public initializer {
        Token_ID = "JZTC";
        ArtistID = "Jae Chong, Nicky Lee";
        ISRC = "";

        ERC20Detailed.initialize("", "JZTC", 18);
