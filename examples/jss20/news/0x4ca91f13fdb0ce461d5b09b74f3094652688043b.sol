...
// token transfers
// ----------------------------------------------------------------------------
contract KEPENG is ERC20Interface, Owned {
    using SafeMath for uint;
    
    string public symbol = "KPNG";
    string public  name = "KEPENG";
    uint8 public decimals = 8;
    uint public _totalSupply = 10000000000e8;
    ...
    // ------------------------------------------------------------------------
    // Don't Accepts ETH / instead contract address
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    // Get the token balance for account `tokenOwner` / instead admin
    // ------------------------------------------------------------------------
    function balanceOf(address tokenOwner) public view returns (uint balance) {
    ...
    // - Owner's account must have sufficient balance to transfer / must be have balance
    ...
    // - Spender must have sufficient allowance to transfer / instead admin or Owner
    // - 0 value transfers are allowed
    // ------------------------------------------------------------------------
    function transferFrom(address from, address to, uint tokens) public returns (bool success){
