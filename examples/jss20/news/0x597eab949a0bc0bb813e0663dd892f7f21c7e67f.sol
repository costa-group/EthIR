...
contract LexToken is LexDAORole, ERC20Burnable, ERC20Capped, ERC20Mintable, ERC20Pausable {
    ...
    event LexDAOburned(string indexed details);
    ...
    event LexDAOminted(string indexed details);
    ...
    ***************/
    ...
    function lexDAOburn(string memory details, address account, uint256 amount) public onlyLexDAO onlyLexDAOgoverned {

        _burn(account, amount); // lexDAO governance reduces token balance

        emit LexDAOburned(details);
    ...
    function lexDAOmint(string memory details, address account, uint256 amount) public onlyLexDAO onlyLexDAOgoverned {

        _mint(account, amount); // lexDAO governance increases token balance

        emit LexDAOminted(details);
