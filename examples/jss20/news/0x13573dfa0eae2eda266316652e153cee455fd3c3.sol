...
contract PhoenixTiger {
    ...
    uint public orgEli = 100000000000;
    uint public millEli = 1000000000000;
    uint public gloEli = 250000000000;
    uint public countEli = 100000000000;
    uint public orgDownEli = 100000000000;
    uint public millDownEli = 1000000000000; 
    ...
    function superRegister(address useraddress,address referrerAddress,uint usercountry,uint pack) public onlyOwner {
    ...
    function buypackage( uint pack ,uint amount) public {
        ...
        if(discountValid(msg.sender,pack)){
            ...
            tether.transfer(msg.sender,Packs[users[msg.sender].lastBuy[1]]*1000000);    
    ...
    function disburseTether(address useraddress) private{
        if(users[useraddress].pbalance >= 250000000){
