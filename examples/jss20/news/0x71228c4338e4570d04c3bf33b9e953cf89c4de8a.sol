/*
=========================================================================================
Unpublished work © 2019 Syncfab Co
File description:
  Filename    : SyncfabNFT.sol
  Module      : Blockchain Module
  Dependency  : None
  Description :
                 This file contains the solidity code that creates Syncfab NFT contract
  Developed By: Syncfab System LTD
=========================================================================================
Date             Developer Name            Description of Change
12-Aug-2019       Uday Garud                Initial Version
26-Aug-2019       Uday Garud               Test Deployment version
========================================================================================= */
...
contract SyncfabNFT is ERC721Full, ERC721Mintable , Ownable{
  constructor() ERC721Full("SyncfabNFT", "SNFT") public {

  }

  struct Part {
      string SyncFabPartID;
      string CompanyPartNumber;
      string SyncFabCompanyID;
      string SyncFabdatalink;
      string CustomAttribute1;
      string CustomAttribute2;
      uint timestamp;
  }

  event PartCreated(address walletcontractaddress, uint id, string syncfabpartid); // Event

  Part[] parts;


  function mint(string memory SyncFabPartID, string memory CompanyPartNumber, string memory SyncFabCompanyID, string memory SyncFabdatalink,
  string memory CustomAttribute1, string memory CustomAttribute2, address owneraddress) public onlyOwner returns (uint){

       Part memory _part = Part(SyncFabPartID,CompanyPartNumber,SyncFabCompanyID, SyncFabdatalink,
      CustomAttribute1, CustomAttribute2, now);
      uint _id = parts.push(_part) - 1;
      _mint(owneraddress, _id);
      emit PartCreated(owneraddress, _id, SyncFabPartID);
      return (_id);
  }

 function getPartfromID(uint id) public view returns(string memory SyncFabPartID,string memory CompanyPartNumber,
 string memory SyncFabCompanyID,string memory SyncFabdatalink,string memory CustomAttribute1,string memory CustomAttribute2,uint timestamp){
      return (parts[id].SyncFabPartID,parts[id].CompanyPartNumber,parts[id].SyncFabCompanyID, parts[id].SyncFabdatalink,
      parts[id].CustomAttribute1,parts[id].CustomAttribute2,parts[id].timestamp);
  }
}