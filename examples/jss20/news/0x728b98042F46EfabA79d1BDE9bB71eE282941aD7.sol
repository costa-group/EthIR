...
contract GODBeastCoinToken is StandardToken, SafeMath {

    // metadata
    string  public constant name = "GOD Beast Coin";
    ...
    // constructor
    function GODBeastCoinToken()
    {
        ethFundDeposit = 0x0DC090b3E72A6ec2E0E78EC028659221f76db330;
        ...
        totalSupply = formatDecimals(330000000);
