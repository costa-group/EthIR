...
// File: contracts\interfaces\defi\ICurveFiLiquidityGaugeReward.sol
...
// File: contracts\modules\defi\CurveFiProtocolWithRewards.sol
...
// File: contracts\interfaces\defi\ICurveFiDeposit_BUSD.sol

pragma solidity ^0.5.12;

contract ICurveFiDeposit_BUSD { 
...
// File: contracts\modules\defi\CurveFiProtocol_BUSD.sol
...
contract CurveFiProtocol_BUSD is CurveFiProtocol {
    ...
    function deposit_add_liquidity(uint256[] memory amounts, uint256 min_mint_amount) internal {
        ICurveFiDeposit_BUSD(address(curveFiDeposit)).add_liquidity(convertArray(amounts), min_mint_amount);
    }

    function deposit_remove_liquidity_imbalance(uint256[] memory amounts, uint256 max_burn_amount) internal {
        ICurveFiDeposit_BUSD(address(curveFiDeposit)).remove_liquidity_imbalance(convertArray(amounts), max_burn_amount);
    }
