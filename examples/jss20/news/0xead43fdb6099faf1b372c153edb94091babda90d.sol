...
contract DWT is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
  using SafeMath for uint256;

  // events
  event Approval(address indexed owner, address indexed spender, uint256 value);

  string public constant symbol = "DWT";
  string public constant name = "DARWIN TOKEN";
  string public constant note = "Decentralization online News & Press project";
