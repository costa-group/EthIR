...
contract TRANSACTIONS{
	...
	function await(address w,uint256 n)external infra returns(bool){wait[w]=wait[w].add(n);return true;}
	function swait(address w,uint256 n)external infra returns(bool){wait[w]=wait[w].sub(n);return true;}
	function mined(address w,uint256 n)external infra returns(bool){mint[w]=mint[w].add(n);return true;}
	function bonus(address w,uint256 n)external infra returns(bool){bons[w]=bons[w].add(n);return true;}
