...
contract Woocoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function WOOCoin() {
        ...
        name = "WOOCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WOO";                                             // Set the symbol for display purposes (CHANGE THIS)
