...
contract SuperOneToken is StandardToken, Ownable {
    ...
    function finalize() onlyOwner {
        ...
        // Transfer the rest of token to SuperOneToken
    ...
    // This function will destroy all SOT and alocate 1-to-1 SOTF token 
