...
contract Kek is MintableToken, HasNoEther 
{
    ...
    //////////////////////////////////////////////////
    /// State Variables for the Kek token contract
    //////////////////////////////////////////////////
    ...
    */
    ...
    //////////////////////////////////////////////////
    /// Begin Kek token functionality
    //////////////////////////////////////////////////

    /// @dev Kek token constructor
    function Kek() public
    {
        // Define owner
        owner = msg.sender;
    ...
    {
        // Require that a Kek split actually be split with an address
    ...
    function claimStake() external returns (bool success)
    {
        ...
        // Subtract stake balance from totalKekStaked
    ...
    function calculateStakeGains(uint _timePassedSinceStake) view private returns (uint mintTotal)
    {
        ...
        uint _finalMintRate;            // store our calculated final mint rate (in Kek-per-second)
        ...
        if (_timePassedSinceStake > _secondsPerDay) {
            ...
            // First, calculate our final stake percentage based upon the total amount of Kek staked
            ...
            // Finally, calculate our final mint rate (in Kek-per-second)
