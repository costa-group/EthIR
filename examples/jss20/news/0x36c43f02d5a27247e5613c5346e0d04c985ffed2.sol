...
contract NNCToken is PausableToken {
    string  public  constant name = "NIUNIUCOIN";
    string  public  constant symbol = "NNC";
    ...
    function NNCToken( address _admin, uint _totalTokenAmount ) 
    {
        // assign the admin account
        admin = _admin;

        // assign the total tokens to NNC
