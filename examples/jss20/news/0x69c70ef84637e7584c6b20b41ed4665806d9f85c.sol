...
website:    https://hex3d.win

discord:    https://discord.gg/UG7TRz5


33% Dividends Fees for Token Exchange

Players are rewarded with the ETH Threshold Bonus when their Buy causes the total ETH 
Balance to cross the next ETH Bonus Threshold.

ETH Thresholds increase by 10 ETH after every BONUS.

Whether you spend 5 ETH or 0.005 ETH to cross you win the BONUS.

BONUS winnings are automatically added to your dividends.

ETH Threshold BONUS is funded with 10% of the BUY/SELL transactions
