...
contract FCAToken is PausableToken {
    string  public  constant name = "FREE CARRIER";
    string  public  constant symbol = "FCA";
    ...
    function FCAToken(address _admin, uint _totalTokenAmount) public
    {
        admin = _admin;
