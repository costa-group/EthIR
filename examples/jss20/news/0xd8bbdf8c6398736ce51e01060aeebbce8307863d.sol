...
// File: browser/VestingContract.sol
...
contract TokenVesting is Ownable {
    ...
    /**
     * @dev Calculates and returns the amount that has already vestedAmount
     * @param token ERC20 token which is being vested
     */
    function vestedAmount(IERC20 token)public view returns (uint){
     ...
     * @param token ERC20 token which is being vested
     */
     function releasableAmount(IERC20 token) public view returns(uint){
