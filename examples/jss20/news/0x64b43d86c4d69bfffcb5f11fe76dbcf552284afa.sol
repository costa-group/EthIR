 ...
 * @dev Implementation of ERC20 standard designed for highly-generalizable tokenization with lexDAO operators.
 ...
 * @dev Factory pattern to clone new token contracts with lexDAO operators.
...
contract lexTokenFactory {
    ...
    event lexDAOupdated(address indexed newLexDAO);

    

    constructor (address payable _manager, address payable lexDAO, string memory _stamp) public 
    ...
    function newlexToken( // public can issue stamped lex token for factory (Ξ) fee
        ...
        emit Deployed(address(LT), owner);
    ...
    function payLexDAO() public payable { 
