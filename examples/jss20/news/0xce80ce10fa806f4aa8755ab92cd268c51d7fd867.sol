...
// File: contracts/IdallToken.sol

pragma solidity ^0.4.18;


contract IdallToken is PausableToken {

    string  public  constant name = "Idall";
    string  public  constant symbol = "IDALL";
    uint8   public  constant decimals = 5;

    mapping(address => uint) approvedInvestorListWithDate;

    function IdallToken( address _admin, uint256 _totalTokenAmount )
    {
        admin = _admin;
