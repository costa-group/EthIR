...
contract tissueBeta is MintableToken, BurnableToken  {
    ...
    */
    string public name = "tissueBeta";
    string public symbol = "TBe";
    uint public constant decimals = 0;
    uint256 public constant INITIAL_SUPPLY = 654123 * (10 ** uint256(decimals));
    string public Image_root = "https://swarm.chainbacon.com/bzz:/aac6a9a0697167751afce7f674e48e5a9700c2871f4e9716a29216b107f73333/";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/22daf398c4a2f9fbcf22eefca03bb147f2781e61c2fd99650e3f46a3756a750f/";
    string public DigestCode_root = "a1cf276de5141ccacf82ab574be0db6d6147ab83b729c6ab28b4a3ddeca43371";
    function getIssuer() public pure returns(string) { return  "Someone"; }
    function getSource() public pure returns(string) { return  "MuseeDuLouvre"; }
