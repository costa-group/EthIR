...
contract Br0manc01n {
    ...
    address public BroManCoinOverFlowAddr;
    ...
    constructor() public {
        owner = msg.sender;
        BroManCoinOverFlowAddr = 0x624F46feE24E5c0f0F3a005c8906A67303324140;
    }
    ...
    function invest(address _referredBy) public payable {
       ...
       BroManCoinOverFlowAddr.transfer(msg.value.mul(5).div(100));
