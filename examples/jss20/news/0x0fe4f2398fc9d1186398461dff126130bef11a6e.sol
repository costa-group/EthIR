...
//   string public creatorName;
   ...
   //owner of the contract - can add new nifties.
   //will always be the master key of nifty gateway
   ...
   function giftNifty(address collector_address, uint niftyType) onlyValidSender public {
