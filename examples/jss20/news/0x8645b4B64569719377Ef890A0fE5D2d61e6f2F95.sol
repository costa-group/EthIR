...
contract UniswapTradeExample{
    ...
    function buyDai() payable returns(uint256){
        ...
        //DH Uniswap exchange address for the token
        address daiAddress = 0x2a1530C4C41db0B0b2bB646CB5Eb1A67b7158667;
        //Define Uniswap
        ...
        //address of the dia token contract
    ...
    function getDAIPrice() constant returns(uint256){
        //constant functions just return informatino from the blockchain and do not cost money/gas.
        OrFeedInterface orfeed= OrFeedInterface(0x8316b082621cfedab95bf4a44a1d4b64a6ffc336);
        //third argument below is who to get the exchange rate from.
        uint256 ethPrice = orfeed.getExchangeRate("ETH", "DAI", "DEFAULT", 100000000);
        return ethPrice;
    }
