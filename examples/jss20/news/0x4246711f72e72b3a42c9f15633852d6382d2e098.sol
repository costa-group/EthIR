...
contract MintableAndPausableToken is ERC20Pausable, Ownable {
    ...
    uint256 public maxTokenSupply = 180000000 * 10 ** uint256(decimals);
...
/**
 * Token upgrader interface by Nordic Energy.
 *
...
contract Token is UpgradeableToken, ERC20Burnable {
    ...
    constructor (address _netWallet, address _upgradeMaster, uint256 _INITIAL_SUPPLY, uint256 _HoldPremiumCap)
        public
    ...
    */
    ...
    function signUpForRefund( uint256 _value ) public {
        require( HoldPremium[msg.sender].HoldTokens != 0 || HoldPremium[msg.sender].buybackTokens != 0, "You must be ICO/STO user to sign up" ); //the user was registered in ICO/STOs
