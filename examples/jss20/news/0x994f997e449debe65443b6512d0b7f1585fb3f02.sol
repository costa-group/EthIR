...
//
// TEST CONTRACT! 10 MINUTE EXPIRATION! TEST CONTRACT! 
//
...
contract LockMyTokens {
    ...
    address constant tokenContract = 0xb83Cd8d39462B761bb0092437d38b37812dd80A2;
    uint constant PRECISION = 1000000000000000000;
    uint constant timeUntilUnlocked = 10 minutes;         // All tokens locked for 1 year after contract creation.
    uint constant maxWithdrawalAmount = 1 * PRECISION;  // Max withdrawal of 1 token per week per user once 1 year is hit.
    uint constant timeBetweenWithdrawals = 7 minutes;
    uint unfreezeDate;
