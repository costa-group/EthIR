...
contract Flower is CreditableToken, RepaymentToken, StockMintToken {
    ...
    */
    ...
    string public symbol = "AHF";
    uint public constant decimals = 0;
    uint256 public constant INITIAL_SUPPLY = 1 * (10 ** uint256(decimals));
    string public Image_root = "https://swarm.chainbacon.com/bzz:/1439278b5e75766bfb93590ee4aa5148ab36c507ad8bcff74db29465724813b2/";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/41c5c8de2af90d2ef8491ea663cdef49d18d6b82daf0d199204a7b74b0fb5fd0/";
    string public Document_root = "none";
    string public DigestCode_root = "2e162b64d92446c69752a5b7e80cac24e6e5f09a0d2d0683f96a18d9092728ee";
    function getIssuer() public pure returns(string) { return  "SomeoneDimensionArt"; }
    function getTrustee() public pure returns(string) { return  "DimensionArt"; }
