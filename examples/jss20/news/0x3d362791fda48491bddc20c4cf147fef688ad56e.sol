...
/**
 * @title DharmaDaiUpgradeBeacon (staging version)
 * @author 0age
 * @notice This contract holds the address of the current implementation for the
 * Dharma Dai token and lets a controller update that address in storage.
 */
contract DharmaDaiUpgradeBeaconStaging {
