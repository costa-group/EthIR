...
contract MDPLPToken is Initializable, ERC20Detailed, ERC20Mintable, ERC20Pausable, ERC20Rewardable {
    ...
    function initialize() public initializer {
        Token_ID = "MDPLP";
        ArtistID = "MachiDidi, Jae Chong, Stanley Huang, Luke Tsui";
        ISRC = "";

        ERC20Detailed.initialize("", "MDPLP", 18);
