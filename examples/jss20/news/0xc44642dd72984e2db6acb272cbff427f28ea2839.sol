...
contract TxBatching is Ownable {
  /**
   * @notice Batch transfer amounts to payees in a single token.
   * @param payees array of recipient addresses
   * @param amounts array of amounts to send to payees
  ...
  /**
   * @notice Claim total balance from the contract.
   */
  ...
  /**
   * @notice Kill the contract and recover any funds.
   */
