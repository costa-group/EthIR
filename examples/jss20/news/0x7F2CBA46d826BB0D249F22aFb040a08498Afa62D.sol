...
contract PausableToken is BasicToken, ERC20Detailed, Pausable, ERC20Burnable, Mintable {
    string public constant NAME = "Victor-M";
  ...
  */
    ...
    constructor () public ERC20Detailed("Victor-M", "VCT", 8) {
         _mint(0xaDb2BbDdb3d5b12a85B63B8fe2cfB8C3C18d8B51, 10000000000 * (10 ** uint256(decimals())));
    } 
}