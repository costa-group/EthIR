...
contract BaiSuiChainToken is StandardToken, Ownable {
  string public constant name = "Bai Sui Chain Token"; // solium-disable-line uppercase
  string public constant symbol = "BSCT"; // solium-disable-line uppercase
  uint8 public constant decimals = 8; // solium-disable-line uppercase
  
  uint256 constant MAX_SUPPLY = 10 * 10000 * 10000 * (10 ** uint256(decimals));
