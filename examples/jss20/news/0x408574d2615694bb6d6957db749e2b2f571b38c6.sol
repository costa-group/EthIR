...
// File: contracts\HKExCoin2.sol

/*****************************************************************************
 *
 *Copyright 2018 HKExCoin2
 *
...
contract HKExCoin2 is PausableToken
{
  using SafeMath for uint256;
  
  // ERC20 constants
  string public name="HKExCoin2";
  string public symbol="HKC2";
  string public standard="ERC20";
  
  uint8 public constant decimals = 18; // solium-disable-line uppercase
  
  uint256 public constant INITIAL_SUPPLY = 9.49 *(10**8)*(10 ** uint256(decimals));
