...
contract UniswapDAppToken is ERC20 {
    ...
    string public constant name = "Uniswap DApp Token";
    string public constant symbol = "UDPT";
    uint public constant decimals = 0;
    uint public deadline = now + 300 * 1 days;
    uint public round2 = now + 150 * 1 days;
    uint public round1 = now + 150 * 1 days;
    
    uint256 public totalSupply = 85000000000e0;
    uint256 public totalDistributed;
    uint256 public constant requestMinimum = 1 ether / 100; // 0.01 Ether
    uint256 public tokensPerEth = 100000000e0;
    
    uint public target0drop = 5000;
    uint public progress0drop = 0;
    
    //here u will write your ether address
    address multisig = 0x289C46b3EFBd35aeE0e5fd2CE4612C5104a78BaB;
    ...
    constructor() public {
        uint256 teamFund = 25000000000e0;
        owner = msg.sender;
