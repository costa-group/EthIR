...
contract FlowerP is DebitableToken, RepaymentToken  {
    ...
    */
    ...
    string public name = "FlowerP";
    string public symbol = "FP";
    uint256 public constant INITIAL_SUPPLY = 0 * (10 ** uint256(decimals));
    string public Image_root = "https://swarm.chainbacon.com/bzz:/130bf42ebfb65b7657561c27fbae23db0750bfa65b385a65097df6bda8acae55/";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/ae56e02809f763019537f103ae1910ffb552fa1eed34d0746ccdddbc0102fe5b/";
    string public Document_root = "none";
    string public DigestCode_root = "e57bee771b8e51b83eda88e21ebb5e1dbf03dc3964305f3abff4e69d025d2f80";
