...
contract FlashXAdvance is ERC20Detailed ,Owned {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "FlashX Advance";
  string constant tokenSymbol = "FSXA";
  uint8  constant tokenDecimals = 8;
  uint256 _totalSupply = 50000000000000000;
  uint256 public basePercent = 100;

  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0x8f0F8B3e4CFd98bFb580C55716c6D6CCe471aBa9, _totalSupply);
  }
  ...
  function isSupplyLessThan100Million() public view returns(bool){
      uint256 hundredMillion = 10000000000000000;
