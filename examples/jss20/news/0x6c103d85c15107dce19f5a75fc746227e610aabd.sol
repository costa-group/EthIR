...
// File: contracts/ProxyToken/instances/UniversalEuro.sol
...
contract UniversalEuro is ProxyToken {
  /**
  * @notice Constructor for the UniversalEuro
  * @param owner owner of the initial proxy tokens
  */
  constructor(address owner) public ProxyToken(owner, "Universal Euro", "UPEUR", 2, 0) {} // solium-disable-line no-empty-blocks
}