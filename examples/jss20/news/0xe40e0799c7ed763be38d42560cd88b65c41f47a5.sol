...
/**
 * @title PlayBaby Token
 * @dev Global digital painting asset platform token.
 * @author playbaby.org 
 */
contract PlayBabyToken is PausableToken, FrozenableToken 
{

    string public name = "PlayBaby";
    string public symbol = "BABY";
    uint256 public decimals = 18;
    uint256 INITIAL_SUPPLY = 192604090 * (10 ** uint256(decimals));
