...
/**
 * @dev Implementation of ERC20 standard designed for highly-generalizable tokenization.
 */
contract standardToken is ERC20Detailed, ERC20Burnable, ERC20Capped, ERC20Pausable {
...
/**
 * @dev Factory pattern to clone new standard token contracts.
 */
contract standardTokenFactory {
    ...
    address[] public tokens; // index of tokens
...
/**
 * @dev Factory pattern to clone new standard token factory contracts.
 */
contract standardTokenFactoryMaker {
    // presented by OpenEsquire || lexDAO 

    standardTokenFactory private factory;
    ...
    function newStandardTokenFactory(string memory _stamp, bool _gated, address _deployer) public {
        factory = new standardTokenFactory(_stamp, _gated, _deployer);
    ...
    function tipLexDAO() public payable { // forwards ether (Ξ) tip to lexDAO Cooperative
        address(0x97103fda00a2b47EaC669568063C00e65866a633).transfer(msg.value);
    }
