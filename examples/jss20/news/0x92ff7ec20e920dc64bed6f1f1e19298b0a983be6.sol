...
contract ETHMaglc is UtilETHMaglc, WhitelistAdminRole {
    ...
    string constant private name = "eth maglc foundation";

    uint ethWei = 1 ether;

    address payable private devAddr = address(0x34F3D97F1d1794b8BD963AB0D817Bc136a87056F);
    address payable private savingAddr = address(0x2a4a4baB2F50FF69606cA17Ad9BF37B356640CE5);
    address payable private follow = address(0x473459991E1A56acB042d992CFf77254405d7972);
