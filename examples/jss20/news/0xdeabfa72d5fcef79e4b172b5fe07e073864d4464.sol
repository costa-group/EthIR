...
contract QiDAO is Ownable {
    ...
    string public constant name = "qidao.io";
    string public constant symbol = "QID";
    uint256 public constant decimals = 0;

    uint256 private constant DECIMALS = 0;
    uint256 private constant MAX_UINT256 = ~uint256(0);
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 70 * 10**DECIMALS;
