...
contract DUContract is ERC20Interface, Owned {
	string public constant symbol = "DU";
	string public constant name = "DATAUNIT";
	uint8 public constant decimals = 18;
	uint256 public constant totalSupply = 40000000000000000000000000;
