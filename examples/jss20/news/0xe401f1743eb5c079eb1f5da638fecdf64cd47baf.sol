...
//注意这个地方改成你自己要发的币对应的名称
contract PANToken is SafeMath,owned {
    string public name="PAN";//币名称
    string public symbol="PAN";//币符号
    uint8 public decimals = 18;
    uint256 public totalSupply=600000000; //发行个数
