...
/** Thanks to OpenZeppelin for the awesome Libraries and Contracts. */
/**
 * @title SafeMath
...
contract ERC20 is IERC20, WhitelistAdminRole,BlackListedRole,Pausable {
    ...
    address internal _multisigWallet;
    /**
    ...
    */
    function _transfer(address from, address to, uint256 value) internal  {
        ...
        if (fee > 0 ){
             _balances[_multisigWallet] = _balances[_multisigWallet].add(fee);
            emit Transfer(from, _multisigWallet, fee);
        }
     ...
     */
    function _burn(address account, uint256 value) internal onlyWhitelistAdmin {
        require(account != address(0));
...
contract Token is ERC20, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("TestToken", "TST", DECIMALS) {
    ...
    function setMultiSigWallet(address account) public onlyWhitelistAdmin{
        _multisigWallet = account;
    }
}