...
contract yCurveZapSwapV4toV3 is ReentrancyGuard, Ownable {
      ...
      nonReentrant
  {
      ...
      if (IERC20(yUSDCv3).balanceOf(address(this)) > 0) {
        yERC20(yUSDCv2).withdraw(IERC20(yUSDCv3).balanceOf(address(this)));
      }
      ...
      IERC20(yBUSDv3).safeTransfer(msg.sender, IERC20(yBUSDv3).balanceOf(address(this)));
      require(IERC20(yBUSDv3).balanceOf(address(this)) == 0, "yBUSDv3 remainder");
