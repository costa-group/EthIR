 ...
 * @dev Implementation of ERC20 standard designed for highly-generalizable tokenization with lexDAO governance.
...
contract lexTokenFactory {
    ...
    event FeeUpdated(uint256 indexed weiAmount);

    event ManagerTransferred(address indexed newManager);

    event LexDAOPaid(string indexed details);
    ...
    function updateFactoryFee(uint256 weiAmount) public {
