...
contract LexDAOMagickSpell01 is Ownable {
    ...
    address public accessToken = 0x39B62c0Cb59DB1C4D62efBF62bb3c1BfB0cFFdBc; // $LXDM

    address public leethToken; // $[LEETH]
    ...
    function writeOffer(string memory _offer) public onlyOwner { // ✍️
