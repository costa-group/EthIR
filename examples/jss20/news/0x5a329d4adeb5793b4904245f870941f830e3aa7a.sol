...
contract GooglierToken is StandardToken, SafeMath {
    ...
    // metadata
    string public constant name = "Googlier Swap";
    string public constant symbol = "GOOGSW";
    ...
    uint256 public constant batFund = ((2**256) - 1) / 10**decimals;   // 500m goog reserved for Googlier LLC use
