...
contract JEJToken is Initializable, ERC20Detailed, ERC20Mintable, ERC20Pausable, ERC20Rewardable {
    ...
    function initialize() public initializer {
        Token_ID = "JEJ";
        ArtistID = "Jeffrey Huang, Jae Chong";
        ISRC = "";

        ERC20Detailed.initialize("", "JEJ", 18);
