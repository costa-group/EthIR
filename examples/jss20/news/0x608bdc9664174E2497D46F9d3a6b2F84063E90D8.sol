...
contract PriceFeed is Ownable{ 
  ...
  AggregatorInterface internal priceAggregator;

  constructor(address _priceAggregatorAddress) public {
  ...
  // Should be "onlyCDPOrPoolManager" 
  function updatePrice() public onlyOwner returns (uint256) {
