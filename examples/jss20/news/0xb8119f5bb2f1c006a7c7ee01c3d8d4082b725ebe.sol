// File: contracts/vendor/introspection/IERC165.sol
...
// File: contracts/vendor/token/ERC721/IERC721.sol
...
// File: contracts/vendor/token/ERC721/IERC721Receiver.sol
...
// File: contracts/vendor/math/SafeMath.sol
...
// File: contracts/vendor/utils/Address.sol
...
// File: contracts/vendor/drafts/Counters.sol
...
// File: contracts/vendor/introspection/ERC165.sol
...
// File: contracts/vendor/token/ERC721/ERC721.sol
...
// File: contracts/vendor/access/Roles.sol
...
// File: contracts/vendor/access/Governable.sol
...
// File: contracts/saja/contracts/BidHistory/BidHistoryAttributes.sol
...
contract BidHistoryAttributes is ERC721 {
    // Mapping for token winner name
    mapping(uint256 => string) private _tokenWinnerName;

    // Mapping for token product name
    ...
    /**
     * @dev Returns the winner name of a given token ID.
    ...
    /**
     * @dev Returns the product name of a given token ID.
     *      Throws if the token ID does not exist.
     * @param tokenId uint256 ID of the token to query
     */
    ...
    /**
     * @dev Returns the bid price of a given token ID.
     *      Throws if the token ID does not exist.
     * @param tokenId uint256 ID of the token to query
     */
    ...
    /**
     * @dev Internal function to set the token winner name for a given token.
     *      Reverts if the token ID does not exist.
     * @param tokenId uint256 ID of the token
     * @param winnerName srting winner name to assign
     */
    ...
    /**
     * @dev Internal function to set the token product name for a given token.
     *      Reverts if the token ID does not exist.
     * @param tokenId uint256 ID of the token
     * @param productName srting product name to assign
     */
    ...
    /**
     * @dev Internal function to set the token bid price for a given token.
     *      Reverts if the token ID does not exist.
     * @param tokenId uint256 ID of the token
     * @param bidPrice uint256 bid price to assign
     */
...
// File: contracts/saja/contracts/BidHistory/BidHistoryMintable.sol
    ...
    Governable
{
     ...
     * @param winnerName The winner name of the minted token.
     * @param productName The prodcut name of the minted token.
     * @param bidPrice The bid price of the minted token.
    ...
    /**
     * @dev Function to set the token winner name for a given token.
     *      Throws if the msg.sender is not governor.
     * @param tokenId uint256 ID of the token
     * @param winnerName string winner name to assign
     * @return A boolean that indicates if the operation was successful.
     */
    ...
    /**
     * @dev Function to set the token product name for a given token.
     *      Throws if the msg.sender is not governor.
     * @param tokenId uint256 ID of the token
     * @param productName string product name to assign
     * @return A boolean that indicates if the operation was successful.
     */
    ...
    /**
     * @dev Function to set the token bid price for a given token.
     *      Throws if the msg.sender is not governor.
     * @param tokenId uint256 ID of the token
     * @param bidPrice uint256 bid price to assign
     * @return A boolean that indicates if the operation was successful.
...
// File: contracts/saja/contracts/BidHistory/BidHistory.sol
