...
/**
 * @dev Extension of ERC20 standard designed for simple 'personal token' deployments with lexDAO Arbitration.
 */
contract lexDAOPersonalToken is lexDAORole, ERC20Burnable, ERC20Detailed, ERC20Mintable {
    ...
    constructor (string memory _name, string memory _symbol, string memory _stamp, uint8 _decimals, uint256 _init, address owner, address _lexDAO) public ERC20Detailed(_name, _symbol, _decimals) {
        _mint(owner, _init);
        _addMinter(owner);
        _addlexDAO(_lexDAO);
        lexDAO = _lexDAO;
...
contract lexDAOPersonalTokenFactory {
    // presented by OpenESQ || lexDAO
    
    uint8 public version = 1;
    
    address public lexDAO = 0x2DB59d02556038c6A702b1CeA4F162f6bD556AD1; // lexDAO Agent
    
    lexDAOPersonalToken private PT;
