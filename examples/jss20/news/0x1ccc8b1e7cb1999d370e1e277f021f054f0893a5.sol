...
// File: contracts/misc/DSMath.sol
...
contract DSMath {
    ...
    //
    function rpow(uint x, uint n) internal pure returns (uint z) { // solium-disable-line security/no-assign-params
        z = n % 2 != 0 ? x : RAY;
...
// File: contracts/misc/AuctionUtils.sol
