...
contract YuCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function YuCoin() {
        ...
        name = "YuCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "YUC";                                             // Set the symbol for display purposes (CHANGE THIS)
