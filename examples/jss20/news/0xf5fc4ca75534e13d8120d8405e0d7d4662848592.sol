...
// File: @aragon/court-presale/contracts/lib/IMarketMaker.sol
...
// File: @aragon/court-presale/contracts/BalanceRedirectPresale.sol
...
// File: contracts/TapDisabled.sol
...
// File: contracts/EOPBCTemplate.sol
...
contract EOPBCTemplate is BaseTemplate {
    ...
    */
    ...
    function _proxifyFundraisingApps(Kernel _dao, MiniMeToken _bondedToken) internal returns (FundraisingApps memory fundraisingApps) {
        ...
        TapDisabled tap = new TapDisabled();
    ...
    function _packFundraisingApps(
        ...
        BatchedBancorMarketMaker             _marketMaker,
        TapDisabled                     _tap,
        AragonFundraisingController              _controller,
        TokenManager            _tokenManager
    )
        internal
        pure
