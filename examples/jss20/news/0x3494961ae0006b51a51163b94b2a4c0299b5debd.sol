...
contract MCDMonitor is ConstantAddresses, DSMath, Static {
    ...
    function repayFor(uint _cdpId, uint _amount, address _collateralJoin, uint _exchangeType, uint _minPrice) public onlyApproved {
    ...
    function boostFor(uint _cdpId, uint _amount, address _collateralJoin, uint _exchangeType, uint _minPrice) public onlyApproved {
