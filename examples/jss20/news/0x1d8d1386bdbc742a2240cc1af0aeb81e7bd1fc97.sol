...
// ----------------------------------------------------------------------------
contract SaromsaryCoinBase is ERC20Interface {
...
// @Desc Cutie Ryu
// ----------------------------------------------------------------------------
contract SaromsaryCoin is SaromsaryCoinBase {
    string public name;
    ...
    event EventAddCoin(uint a_amount, uint a_totalSupply);
     ...
     function SaromsaryCoin(uint a_totalSupply, string a_tokenName, string a_tokenSymbol, uint8 a_decimals) public {
        owner = msg.sender;
