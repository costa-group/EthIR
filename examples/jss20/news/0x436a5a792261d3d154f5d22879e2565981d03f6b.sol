/*! binar.sol | (c) 2020 Develop by BelovITLab LLC (smartcontract.ru), author @stupidlovejoy | SPDX-License-Identifier: MIT License */
...
contract Binar {
    ...
    constructor() public {
        levels.push(0.11 ether);
        levels.push(0.15 ether);
        levels.push(0.41 ether);
        ...
        root = 0xbF49F4ffdf874d4A80A2F3fc22173Bd82C8e2893;
