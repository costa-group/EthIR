 ...
 * derived from Open Zeppelin's ERC20 contract)
 * @notice This contract provides the V0 implementation of Dharma USD Coin (or
 * dUSDC), an upgradeable, interest-bearing ERC20 token with cUSDC as the
 * backing token and USD Coin as the underlying token. The V0 dUSDC exchange
 ...
 * accounts, as well as from contract accounts via ERC-1271. The Dharma USD Coin
 * V0 implementation is an emergency fallback that pauses minting and pulling
 * surplus cUSDC.
 */
