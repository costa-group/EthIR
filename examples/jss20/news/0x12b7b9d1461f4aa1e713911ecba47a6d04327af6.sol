...
contract standardTokenFactory {
    // presented by OpenEsquire || lexDAO LLC
...
contract standardTokenFactoryMaker {
    ...
    function tipLexDAO() public payable { // forwards ether (Ξ) tip to lexDAO LLC Agent
        address(0x8CaBD576D6Bf04B904ce85F94C68f033eA4ae18B).transfer(msg.value);
    }
