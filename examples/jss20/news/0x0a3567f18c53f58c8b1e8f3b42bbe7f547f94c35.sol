...
contract TokenERC20 {
     ...
     */
    constructor() public {
        totalSupply = 120000000 * 10 ** uint256(decimals);  // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;                // Give the creator all initial tokens
        name = 'Resources Cash';                          // Set the name for display purposes
...
contract ResourcesCash is owned, TokenERC20 {
