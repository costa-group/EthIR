...
// File: browser/RWS.sol

/*
 * Robonomics Web Services utility token.
 * (c) Robonomics Team <research@robonomics.network>
 */

pragma solidity ^0.6;

contract RWS is ERC20, ERC20Burnable, Ownable {
    constructor() public ERC20("Robonomics Web Services :: V1", "RWS") {
