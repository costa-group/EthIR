...
contract PremiumFeedPrices{
    ...
    function uniswapPrice(address token1, address token2, string  side, uint256 amount) public constant returns (uint256){
     ...
     function bancorPrice(address token1, address token2, string side, uint256 amount) constant returns (uint256){
        ...
        address token1ToBancor;
        address token2ToBancor;
        ...
        if(equal(side, "BUY")){
            ...
            // The BNT address
            path[1] = IERC20Token(0x1f573d6fb3f13d689ff844b4ce37794d79a7ff1c);
            path[2] = IERC20Token(0x1f573d6fb3f13d689ff844b4ce37794d79a7ff1c);
            path[3] = IERC20Token(token1ToBancor);
            ...
            path[1] = IERC20Token(0x1f573d6fb3f13d689ff844b4ce37794d79a7ff1c);
            path[2] = IERC20Token(0x1f573d6fb3f13d689ff844b4ce37794d79a7ff1c);
            path[3] = IERC20Token(token2ToBancor);
