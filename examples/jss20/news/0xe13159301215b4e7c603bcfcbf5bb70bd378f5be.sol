...
contract UniswapTradeExample{
    ...
    function buyDai() public payable returns(uint256){
        ...
        //token contract address that we're buying... in this case DAI contract of Uniswap
        ...
        // this is the actual DAI/SAI address
        ERC20 daiToken = ERC20(0x89d24A6b4CcB1B6fAA2625fE562bDD9a23260359); //0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359
    ...
    function getDAIPrice() public view returns(uint256){
        //OrFeedInterface contract address
        OrFeedInterface orfeed= OrFeedInterface(0x8316B082621CFedAB95bf4a44a1d4B64a6ffc336);  //0x8316b082621cfedab95bf4a44a1d4b64a6ffc336
