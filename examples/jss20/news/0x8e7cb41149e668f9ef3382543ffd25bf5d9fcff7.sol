...
contract HuaRuiPayToken is SafeMath {
  string public name;
  ...
  function HuaRuiPayToken() {
    ...
    name = 'HuaRui Pay';                          // Set the name for display purposes
    symbol = 'HRP';                          // Set the symbol for display purposes
