...
contract KAN_Token is BurnableToken, Owned {
    string public constant name = "EXKAN";
    string public constant symbol = "KAN";
    uint8 public constant decimals = 18;
 
    /// Maximum tokens to be allocated ( 2 billion KAN)
