/*! tls.token.sol | (c) 2018 Develop by BelovITLab LLC (smartcontract.ru), author @stupidlovejoy | License: MIT */
...
contract Ownable {
    ...
    constructor() public {
        owner = 0x05Ca0F63dF866f465927deE19Cb289941496FCCF;
    }
...
contract Token is StandardToken, CappedToken, BurnableToken, Withdrawable {
    constructor() CappedToken(1000000000000 * 1e2) StandardToken("Stark", "Stark", 2) public {
