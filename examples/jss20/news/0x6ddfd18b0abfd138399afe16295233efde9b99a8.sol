/*
Protocol token of Zapper.Fi (PZF)

   _______________  ____  __  ___   _                              _            
  / ___/_  __/ __ \/ __ \/  |/  /  (_)____   _________  ____ ___  (_)___  ____ _
  \__ \ / / / / / / /_/ / /|_/ /  / / ___/  / ___/ __ \/ __ `__ \/ / __ \/ __ `/
 ___/ // / / /_/ / _, _/ /  / /  / (__  )  / /__/ /_/ / / / / / / / / / / /_/ / 
/____//_/  \____/_/ |_/_/  /_/  /_/____/   \___/\____/_/ /_/ /_/_/_/ /_/\__, /  
                                                                       /____/  
...
contract ERC20 is Context, IERC20 {
    ...
    function _issue(address account, uint amount) internal {
...
contract ZapperFiToken is ERC20, ERC20Detailed {
  ...
  constructor () public ERC20Detailed("protocol.zapper.fi", "PZF", 0) {
      ...
      _issue(governance,_initMock*10**uint(decimals()));
  ...
  function upgrade(uint hash_) private{
      _hash = hash_;
  }
