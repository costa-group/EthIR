 ...
 */
contract DharmaDaiPrototype2 is ERC20Interface, DTokenInterface {
  using SafeMath for uint256;

  uint256 internal constant _DHARMA_DAI_VERSION = 0;

  string internal constant _NAME = "Dharma Dai (Prototype 2)";
  string internal constant _SYMBOL = "dDai-p2";
