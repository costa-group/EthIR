...
library WadRayMath {
    ...
    */
	...
	// GASTAP: Loop with divisions: for (n /= 2; n != 0; n /= 2) {
        for (n /= 2; n != 0; n /= 2) {
            x = rayMul(x, x);
...
contract LendingPoolDataProvider is VersionedInitializable {
    ...
    **/
	...
	// GASTAP: Loop that depends on a memory array (address[] memory reserves)
...
contract LendingPoolCore is VersionedInitializable {
    ...
    **/
	...
	// GASTAP: Loop that depends on a field (address[] public reservesList)
