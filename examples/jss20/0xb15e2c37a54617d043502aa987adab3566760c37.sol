...
contract FZC is UtilFZC, WhitelistAdminRole {
        ...
        isHuman()
    {
        ...
        tokenTransfer(tokencontract).transferFrom(msg.sender,address(address(this)),value.div(1e18));
        ...
        isHuman()
    {
        ...
        if (resultMoney > 0) {
            tokenTransfer(tokencontract).transfer(msg.sender,resultMoney.div(1e18));
