...
contract MDMDToken is Initializable, ERC20Detailed, ERC20Mintable, ERC20Pausable, ERC20Rewardable {
    ...
    function initialize() public initializer {
        Token_ID = "MDMD";
        ArtistID = "MachiDidi, Jeffrey Huang";
        ISRC = "";

        ERC20Detailed.initialize("", "MDMD", 18);
