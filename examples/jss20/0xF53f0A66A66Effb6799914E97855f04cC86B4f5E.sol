...
contract Ethera {
  ...
  constructor() public {
    ...
    levelPrice[5] = 0.05 ether;
    levelPrice[6] = 0.06 ether;
    levelPrice[7] = 0.07 ether;
    levelPrice[8] = 0.08 ether;
    levelPrice[9] = 0.09 ether;
    levelPrice[10] = 0.10 ether;
    uplinesToRcvEth[1] = 10;
    uplinesToRcvEth[2] = 10;
    uplinesToRcvEth[3] = 10;
    uplinesToRcvEth[4] = 10;
    uplinesToRcvEth[5] = 10;
    uplinesToRcvEth[6] = 10;
    uplinesToRcvEth[7] = 10;
    uplinesToRcvEth[8] = 10;
    uplinesToRcvEth[9] = 10;
    uplinesToRcvEth[10] = 10;
  ...
  function getUserLevel (address _user) public view returns (uint) {
      ...
      else if (getUserLevelExpiresAt(_user, 11) < now) {
          return (10);
      }
  }
