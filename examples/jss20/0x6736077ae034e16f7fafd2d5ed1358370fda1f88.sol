...
contract PHEBase is ERC20 {
     ...
     */
    function PHEBase(uint256 _initialSupply, string _tokenName, string _tokenSymbol, uint8 _decimals) public {
...
contract PHEToken is PHEBase {

    function PHEToken() PHEBase(10000000000, "Phoenix Ecology", "PHE", 6) public {
