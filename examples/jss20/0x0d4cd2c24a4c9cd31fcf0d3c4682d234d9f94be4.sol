...
contract StakingRewards is StakingTokenWrapper, RewardsDistributionRecipient {
    ...
    ****************************************/
    ...
    /**
     * @dev Collects the accumulated BAL token from the contract
    ...
    function collectRewardToken(
        ...
        onlyGovernor
    {
        // Official checksummed BAL token address
        ...
        uint256 balance = balToken.balanceOf(address(this));

        require(balToken.transfer(_recipient, balance), "Collection transfer failed");
    }
}