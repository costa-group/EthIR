...
contract EUROSTABLECOINConstants {
    ...
    string public name = "EUROSTABLECOIN";
    string public symbol = "EURST";
...
contract EUROSTABLECOIN is owned, ERC20, EUROSTABLECOINConstants,SafeMath  {
