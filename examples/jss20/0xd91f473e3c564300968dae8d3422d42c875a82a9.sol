...
contract Malijun is Context, IERC20, ERC20Detailed("Malijun", "MLJ", 18) {
    ...
    constructor(address founder) public{          // token total number
        _totalSupply = 1e10 * 9 ** uint256(decimals());
