// File: contracts/CrowdsaleDragonFruit.sol
...
contract ERC20Cappuccino is IERC20 {
...
contract Crowdsale is ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for ERC20Mocha;

    // The token being sold
    ERC20Mocha private _token;
     ...
     */
    constructor (uint256 rate, address payable wallet, ERC20Mocha token) public {
 ...
 * version 1.0
 */
contract CrowdsaleDragonFruit is MintedCrowdsale, PausableCrowdsale {
    constructor (uint256 rate, address payable wallet, ERC20Mocha token, bool _isPausable) public
