...
contract Owned {
    ...
    address payable public drawer = 0xE8285bf30feAa5b2e612df9a9996A8Ed0FB59627 ;
...
contract jackpot is ERC20Detailed, Owned {
  ...
  function pickWinner(address[] memory randomEntries) public onlyOwner returns (bool) {
