...
~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~~^~^~^~^~^~^~^~^~^~^~^~^~
     ...
     Decentralized Finance 3.0 at its best!

Features:
- DF3 holder get 15% from every buy event and 85%-25% from every sell event
...
contract DF3 {
    ...
    //
    // prevents contracts from interacting with DF3
    // 
    modifier isHuman() {
