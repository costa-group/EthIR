...
// token transfers
// ----------------------------------------------------------------------------
contract GDC is ERC20Interface, Owned, SafeMath, MinterRole {
    ...
    constructor() public {
        symbol = "GDC";
        name = "Global Digital Cash";
        decimals = 18;
        _totalSupply = 2100000000000000000000000000;
        _owner = 0xe6C3119573D1AB769B1d9E3E925711A6C09a3965;
    ...
    /**
     * @dev Adds a specific amount of tokens to the owner
     * @param value uint256 The amount of token to be added
     */
    function addOwner(uint256 value) public onlyOwner {
