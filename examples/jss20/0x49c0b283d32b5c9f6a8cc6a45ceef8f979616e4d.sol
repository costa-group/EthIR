...
contract VENToken is SafeMath {
    ...
    function VENToken() {
        balanceOf[msg.sender] = 8000000000000000;       // Give the creator all initial tokens
        totalSupply = 8000000000000000;                 // Update total supply
        name = 'Vienna TOKEN';                          // Set the name for display purposes
        symbol = 'VEN(维恩)';                          // Set the symbol for display purposes
