...
contract DigitalNationDollar is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DigitalNationDollar() {
        ...
        name = "DigitalNationDollar";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DND";                                             // Set the symbol for display purposes (CHANGE THIS)
