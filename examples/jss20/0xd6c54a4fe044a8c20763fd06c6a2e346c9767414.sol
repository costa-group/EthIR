...
// adding modifier 
   ...
   require(token.transfer(destAddress, destAmount));
    ...
    return destAmount;
     ...
     function kyberToUniSwapArb(address uniSwapContract, address fromAddress, uint theAmount) public payable onlyOwner returns (bool){
...
// calling function 'swapTokenToEther' wich converts our 'SAI' to ETH
// KYBER
       uint ethBack = swapTokenToEther1(proxy, address1 , theAmount, msg.sender);

// now our smart contract has the ETH

// Then we convert the 'ETH' we get back to 'SAI'
// UNISWAP
...
// This makes the function payable
    function () external payable  {

    }


// all this does is transfer all the ETH and tokens back to person who is requesting this
    function withdrawETHAndTokens() onlyOwner{
// onlyOwner makes shure only the owner of the contract can call this fucntion, check in the beginning of the code
