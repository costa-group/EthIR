...
contract GranC is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
  using SafeMath for uint256;

  // events
  event Approval(address indexed owner, address indexed spender, uint256 value);

  string public constant symbol = "GranC";
  string public constant name = "GranC";
  string public constant note = "GranC aims to establish a platform where the ownership of data belongs to the users and users stand central to identity control and payment services by generating and managing their sole and intrinsic ID.";
