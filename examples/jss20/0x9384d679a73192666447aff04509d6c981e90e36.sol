...
contract CATPOOL is CreditableToken, RepaymentToken, StockMintToken {
    ...
    */
    string public name = "CATPOOL";
    string public symbol = "CAP";
    uint public constant decimals = 8;
    uint256 public constant INITIAL_SUPPLY = 50000 * (10 ** uint256(decimals));
    string public Image_root = "https://swarm.chainbacon.com/bzz:/78521816e31da8b321c4939592809669340a77e453a8a1a84f87e3a87245cafa/";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/ae25a6c846bf3a9e0417d1dfc6b4f7e7a55197135567f92a9d55e79ad3cc2b9b/";
    string public Document_root = "none";
    string public DigestCode_root = "7b02db6f72f29189fc818f7fdb7637b24c2ce890e153593baa905f768b57f896";
    function getIssuer() public pure returns(string) { return  "cat collector"; }
    function getTrustee() public pure returns(string) { return  "Private_inHouse"; }
