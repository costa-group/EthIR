...
/* investment functions */
    ...
    function commitDividend(address _who) internal {
    	require(totalSupply > 0); // SAFEVM Added
	require(dividendPeriod < dividends.length); // SAFEVM Added
...
/* database functions */
	...
	require( delta % hashesSize < hashes.length); //SAFEVM Added
