...
def run_solidity_analysis(inputs, hashes):
    ...
    if len(inputs) == 1 and r:
        ...
        exit_code = 1
        print(
            "Option Error: --verify option is only applied to c translation. Use -c flag\n"
        )
...
def main():
    ...
    six.print_(
        "The files generated by EthIR are stored in the following directory: "
        + global_params_ethir.costabs_path
    )
