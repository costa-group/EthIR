...
def run_solidity_analysis(inputs,hashes):
    ...
    if len(inputs) == 1 and r:
        ...
        if (args.ub_filter_contract == None) or (contract_name.startswith(args.ub_filter_contract)):
        ...
        for inp in inputs:
            ...
            if (contract_name == None) or (contract_name.startswith(args.ub_filter_contract)):
