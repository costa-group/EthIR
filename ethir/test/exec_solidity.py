...
def check_csvfile_exist():
    files = os.listdir(".")
    if "result_solidity.csv" not in files:
        f = open("result_solidity.csv","a")
...
def check_timefile_exist():
    files = os.listdir(".")
    if "time_solidity" not in files:
        f = open("time_solidity.csv","a")
        fp = csv.writer(f, delimiter=',')
...
if __name__ == "__main__":
    ...
    l = os.listdir(".")
    if "time_solidity.csv" in l:
        os.remove("time_solidity.csv")
    if "result_solidity.csv" in l:
        os.remove("result_solidity.csv")
    if "report_solidity.txt" in l:
        os.remove("report_solidity.txt")
