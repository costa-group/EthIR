...
def check_csvfile_exist():
    files = os.listdir(".")
    if "etherpot.csv" not in files:
        f = open("etherpot.csv","a")
...
if __name__ == '__main__':
    ...
    if name != "cfg":
        ...
        if v != -1:
            ...
            for b in v:
                if str(b[0]).find("oraclize_setProof")==-1:
	...
	print "The results are stored in the file pot_results.txt"
    f.close()
